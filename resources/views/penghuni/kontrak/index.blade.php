...
<div class="p-4 md:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('penghuni.dashboard') }}" class="inline-flex items-center text-sm font-black text-gray-600 hover:text-black font-black transition-colors">
                ...
                <li class="inline-flex items-center">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('penghuni.kontrak.index') }}" class="inline-flex items-center text-sm font-black text-black">
    ...
    <div class="space-y-4">
        ...
        <div class="card-hover bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-5 transition-all duration-300
            {{ $k->status_kontrak == 'aktif' ? 'hover:border-black' : 
                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div class="bg-gray-100 border-2 border-black p-3">
                            ...
                            <div class="text-black font-black">{{ $k->durasi_sewa }} {{ $k->unit_label_lower }}</div>
                        </div>
                        ...
                        <div class="bg-gray-100 border-2 border-black p-3">
                            ...
                            <div class="text-black font-black">{{ $k->tanggal_mulai ? $k->tanggal_mulai->format('d M Y') : '-' }}</div>
                        </div>
                        @endif
                        ...
                        <div class="bg-gray-100 border-2 border-black p-3">
                            ...
                            <div class="text-black font-black">{{ $k->tanggal_selesai ? $k->tanggal_selesai->format('d M Y') : '-' }}</div>
                        </div>
                        @endif
                    </div>

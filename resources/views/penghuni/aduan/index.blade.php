                        ...
                        @foreach($aduans as $index => $aduan)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-4 text-center whitespace-nowrap">
                                    <a href="{{ route('penghuni.aduan.show', $aduan->id_aduan) }}" class="inline-flex items-center px-3 py-1.5 bg-sky-400 hover:bg-sky-500 text-black font-black text-xs border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all">
                ...
                @foreach($aduans as $index => $aduan)
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="pt-2 flex justify-end">
                            <a href="{{ route('penghuni.aduan.show', $aduan->id_aduan) }}" class="inline-flex items-center px-3 py-1.5 bg-sky-400 text-black font-black text-xs border-2 border-black shadow-[2px_2px_0px_#000]">
                                <i class="fas fa-eye mr-1"></i>
                                Lihat Detail
                            </a>
                        </div>

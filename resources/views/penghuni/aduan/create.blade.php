...
@section('title', 'Buat Aduan - Penghuni AyoKos')
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            <form method="POST" action="{{ route('penghuni.aduan.store') }}" enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/penghuni/aduan" data-redirect="{{ route('penghuni.aduan.index') }}" data-success-msg="Aduan berhasil dikirim!">
                @csrf

...
<div id="registerToast" class="toast-login">
    <div class="toast-body {{ session('success') ? 'bg-emerald-900/80 border-l-emerald-400' : 'bg-red-900/80 border-l-red-400' }} border-l-4">
        <div class="flex items-start gap-3">
            <i class="fas {{ session('success') ? 'fa-check-circle text-emerald-400' : 'fa-exclamation-circle text-red-400' }} text-lg mt-0.5"></i>
            <div>
                @if(session('success'))
                    {{ session('success') }}
                @else
        ...
        <div class="flex justify-center">
            <div class="register-card">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="tel" id="no_hp_display" class="form-input rounded-l-none @error('no_hp') is-invalid @enderror"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="jenis_kelamin" value="L" class="w-4 h-4 text-sky-500 bg-white/10 border-white/20 focus:ring-sky-500" {{ old('jenis_kelamin') == 'L' ? 'checked' : '' }}>
                                        <span class="text-white text-sm"><i class="fas fa-male mr-1"></i> Laki-laki</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="jenis_kelamin" value="P" class="w-4 h-4 text-sky-500 bg-white/10 border-white/20 focus:ring-sky-500" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }}>
                ...
                <div class="px-6 pb-4 text-center border-t border-white/5 pt-4">
                    ...
                    <a href="{{ route('login') }}" class="text-sky-400 hover:text-sky-300 font-semibold text-sm transition">

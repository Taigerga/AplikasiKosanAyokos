                ...
                <div class="profile-menu relative">
                    ...
                    <div
                        ...
                        <div class="px-4 py-3 border-b border-slate-200">
                            <p class="text-sm font-semibold text-slate-800">{{ $user->pemilik->nama ?? $user->nama ?? 'User' }}</p>
                            <p class="text-xs text-slate-500 truncate">{{ $user->pemilik->email ?? $user->email ?? '-' }}</p>
                        </div>
    ...
    <aside id="sidebar"
        ...
        <nav class="p-4">
            <ul class="space-y-1">
                <li>
                    <a href="{{ route('pemilik.dashboard') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.dashboard') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
                ...
                <li>
                    <a href="{{ route('pemilik.kos.index') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.kos.*') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
                ...
                <li>
                    <a href="{{ route('pemilik.kamar.index') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.kamar.*') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
                ...
                <li>
                    <a href="{{ route('pemilik.kontrak.index') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.kontrak.*') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
                ...
                <li>
                    <a href="{{ route('pemilik.reviews.index') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.reviews.*') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
                ...
                <li>
                    <a href="{{ route('pemilik.pembayaran.index') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.pembayaran.*') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
                ...
                <li>
                    <a href="{{ route('pemilik.analisis.index') }}"
                        class="flex items-center gap-3 px-3 py-3 rounded-lg font-medium {{ request()->routeIs('pemilik.analisis.*') ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-500' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100' }}">
        ...
        <div class="p-4 border-t">
            <div class="text-xs text-slate-500 mb-2">Statistik Cepat</div>
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <span class="font-bold text-slate-800">{{ $user->pemilik?->kos()->count() ?? 0 }}</span>
                </div>
                <div class="flex items-center justify-between text-sm">

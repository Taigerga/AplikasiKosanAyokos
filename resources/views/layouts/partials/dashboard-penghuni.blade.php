            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="{{ route('penghuni.aduan.index') }}"
                        class="flex items-center gap-3 px-3 py-3 font-bold text-sm {{ request()->routeIs('penghuni.aduan.*') ? 'bg-yellow-400 text-black border-l-4 border-yellow-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white border-l-4 border-transparent' }}">

...
@section('title', 'Detail Aduan - Pemilik AyoKos')
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            ...
            <form method="POST" action="{{ route('pemilik.aduan.komentar', $aduan->id_aduan) }}" enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/pemilik/aduan/{{ $aduan->id_aduan }}/komentar" data-success-msg="Komentar berhasil ditambahkan" data-reload="true">
                @csrf

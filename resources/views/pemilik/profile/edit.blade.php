    ...
    <div class="p-4 md:p-6">
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] overflow-hidden">
            <form action="{{ route('pemilik.profile.update') }}" method="POST" class="p-6 md:p-8"
                enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/pemilik/profile/update" data-ajax-method="PUT" data-redirect="{{ route('pemilik.profile.show') }}" data-success-msg="Profil berhasil diperbarui!" data-confirm="Apakah Anda yakin ingin menyimpan perubahan profil?">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ old('nama', $pemilik->nama) }}"
                                    class="w-full pl-10 pr-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('nama') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="username" name="username"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('username') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <select id="jenis_kelamin" name="jenis_kelamin"
                                class="w-full px-4 py-3 border-2 border-black text-black font-bold bg-white focus:shadow-[3px_3px_0px_#000] outline-none transition appearance-none @error('jenis_kelamin') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 border-2 border-black text-black font-bold bg-white focus:shadow-[3px_3px_0px_#000] outline-none transition @error('tanggal_lahir') border-red-500 @enderror">
                            </div>
                            @error('tanggal_lahir')
                                <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email', $pemilik->email) }}"
                                    class="w-full pl-10 pr-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('email') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp', $pemilik->no_hp) }}"
                                    class="w-full pl-14 pr-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('no_hp') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <textarea id="alamat" name="alamat" rows="3"
                                class="w-full px-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition resize-none @error('alamat') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama_bank" name="nama_bank"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('nama_bank') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nomor_rekening" name="nomor_rekening"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('nomor_rekening') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="password" name="password"
                                    class="w-full pl-10 pr-10 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('password') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="w-full pl-10 pr-10 py-3 border-2 border-black text-black font-bold placeholder-gray-500 focus:shadow-[3px_3px_0px_#000] outline-none bg-white transition @error('password_confirmation') border-red-500 @enderror"

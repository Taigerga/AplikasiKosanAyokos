        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        @else
                            <div
                                ...
                                <span
                                    class="text-4xl md:text-5xl text-black font-black">{{ substr($pemilik->nama, 0, 1) }}</span>
                            </div>
                        @endif
            ...
            <div class="pt-20 md:pt-24 px-4 md:px-8 pb-6 md:pb-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div class="flex-1">
                        <h2 class="text-xl md:text-2xl font-black text-black">{{ $pemilik->nama }}</h2>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xl md:text-2xl font-black text-black">{{ $totalKos }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xl md:text-2xl font-black text-black">{{ $totalKamar }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xl md:text-2xl font-black text-black">{{ $kamarTerisi }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 border-2 border-black p-5 md:p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-black">
                                    {{ $pemilik->tanggal_lahir ? \Carbon\Carbon::parse($pemilik->tanggal_lahir)->format('d M Y') : '<span class="text-gray-500">Belum diisi</span>' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 border-2 border-black p-5 md:p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-black">
                                    {{ $pemilik->alamat ?: '<span class="text-gray-500">Belum diisi</span>' }}
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-black">
                                            <span
                                                ...
                                                {{ $pemilik->status_pemilik == 'aktif' ? 'bg-emerald-400 text-black' :
                            ...
                            @foreach($recentKos as $kos)
                                        <a href="{{ route('pemilik.kos.show', $kos->id_kos) }}"
                                            ...
                                            <div class="flex justify-between items-start mb-3">
                                                <h4 class="font-bold text-black truncate">{{ $kos->nama_kos }}</h4>
                                                <span

        ...
        <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-14 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
                    <div class="text-3xl md:text-4xl font-bold text-white">{{ $totalKos ?? '120' }}+</div>
                    <div class="text-sm text-slate-400 mt-1">Kos Tersedia</div>
                </div>
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
                    <div class="text-3xl md:text-4xl font-bold text-white">{{ $totalKamar ?? '680' }}+</div>
                    <div class="text-sm text-slate-400 mt-1">Kamar Kosong</div>
                </div>
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
                    <div class="text-3xl md:text-4xl font-bold text-white">{{ $kotaTerdaftar ?? '25' }}+</div>
                    <div class="text-sm text-slate-400 mt-1">Kota</div>
                </div>
                <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
                    <div class="text-3xl md:text-4xl font-bold text-white">{{ $penghuniAktif ?? '2.5K' }}+</div>
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div class="lg:w-1/2" data-aos="fade-right">
                ...
                <a href="{{ route('public.kos.index') }}" class="inline-flex items-center px-6 py-3 bg-sky-600 text-white font-semibold rounded-xl hover:bg-sky-700 transition shadow-md">
...
<section class="section-padding bg-slate-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="kos-card" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                ...
                <div class="p-5 flex flex-col flex-grow">
                    <div class="flex items-start justify-between mb-2">
                        <h3 class="text-lg font-semibold text-slate-900 line-clamp-1">{{ $kos->nama_kos }}</h3>
                        @if($kos->reviews->avg('rating'))
                        <div class="flex items-center text-amber-500 text-sm ml-2 shrink-0">
                            <i class="fas fa-star mr-1"></i>
                            <span class="text-slate-700 font-medium">{{ number_format($kos->reviews->avg('rating'), 1) }}</span>
                        </div>
                        @endif
                    </div>
...
<section class="section-padding bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mt-8" data-aos="fade-up">
            <a href="{{ route('public.kos.peta') }}" class="inline-flex items-center px-6 py-3 bg-white border-2 border-slate-200 text-slate-700 rounded-xl hover:bg-slate-50 transition font-medium">

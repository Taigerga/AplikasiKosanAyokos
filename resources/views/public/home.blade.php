...
@section('title', 'AyoKos - Tempat Cari Kos Terbaik & Terpercaya')
...
<section class="relative bg-yellow-400 pt-28 pb-16 md:pt-32 md:pb-20 overflow-hidden border-b-4 border-black">
    <div class="container mx-auto px-4 hero-content text-center">
        <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <form action="{{ route('public.kos.index') }}" method="GET" class="max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-14 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="400">
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-5 text-center">
                    <div class="text-3xl md:text-4xl font-black text-black">{{ $totalKos ?? '120' }}+</div>
                    <div class="text-sm font-bold text-gray-700 mt-1">Kos Tersedia</div>
                </div>
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-5 text-center">
                    <div class="text-3xl md:text-4xl font-black text-black">{{ $totalKamar ?? '680' }}+</div>
                    <div class="text-sm font-bold text-gray-700 mt-1">Kamar Kosong</div>
                </div>
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-5 text-center">
                    <div class="text-3xl md:text-4xl font-black text-black">{{ $kotaTerdaftar ?? '25' }}+</div>
                    <div class="text-sm font-bold text-gray-700 mt-1">Kota</div>
                </div>
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-5 text-center">
                    <div class="text-3xl md:text-4xl font-black text-black">{{ $penghuniAktif ?? '2.5K' }}+</div>
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div class="lg:w-1/2" data-aos="fade-right">
                ...
                <a href="{{ route('public.kos.index') }}" class="inline-flex items-center px-6 py-3 bg-lime-400 hover:bg-lime-500 text-black font-black border-2 border-black shadow-[4px_4px_0px_#000] transition-all duration-200 text-sm uppercase">
...
<section class="section-padding bg-white border-t-4 border-black">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border-4 border-black shadow-[6px_6px_0px_#000] overflow-hidden transition-transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                <div class="relative h-52 overflow-hidden border-b-2 border-black">
                    @if($kos->foto_utama)
                        ...
                        @endphp
                        @if($fileExists)
                            <img src="{{ url('storage/' . $kos->foto_utama) }}" alt="{{ $kos->nama_kos }}"
                ...
                <div class="p-5 flex flex-col flex-grow">
                    <div class="flex items-start justify-between mb-2">
                        <h3 class="text-lg font-black text-black line-clamp-1">{{ $kos->nama_kos }}</h3>
                        @if($kos->reviews->avg('rating'))
                        <div class="flex items-center text-black text-sm ml-2 shrink-0 bg-yellow-400 px-2 py-0.5 border-2 border-black">
                            <i class="fas fa-star mr-1"></i>
                            <span class="font-black">{{ number_format($kos->reviews->avg('rating'), 1) }}</span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="flex flex-wrap gap-1.5 mb-4">
                        @foreach($kos->fasilitas->take(4) as $fas)
                        ...
                        @endforeach
                        @if($kos->fasilitas->count() > 4)
                        <span class="px-2.5 py-1 text-xs font-medium bg-gray-100 text-black border-2 border-black">
                            +{{ $kos->fasilitas->count() - 4 }}
                        </span>
                        @endif
                    </div>

                    <p class="text-sm text-gray-800 mb-4 line-clamp-2 font-medium">
                        {{ $kos->deskripsi ?? 'Kos nyaman dengan lingkungan asri, akses mudah ke transportasi umum, dan fasilitas lengkap.' }}
                    </p>
...
<section class="section-padding bg-white border-t-4 border-black">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mt-8" data-aos="fade-up">
            <a href="{{ route('public.kos.peta') }}" class="inline-flex items-center px-6 py-3 border-2 border-black bg-lime-400 hover:bg-lime-500 text-black font-black transition-all duration-200 uppercase shadow-[4px_4px_0px_#000]">
...
<section class="section-padding bg-black text-white border-t-4 border-yellow-400">
    <div class="container mx-auto px-4 text-center" data-aos="fade-up">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('public.kos.index') }}" class="px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-black font-black border-2 border-yellow-400 shadow-[4px_4px_0px_#fff] transition text-lg uppercase">
                <i class="fas fa-search mr-2"></i> Cari Kos Sekarang
            </a>
            @guest
            <a href="{{ route('register') }}" class="px-8 py-4 bg-white text-black font-black border-2 border-white shadow-[4px_4px_0px_#fff] hover:bg-gray-200 transition text-lg uppercase">

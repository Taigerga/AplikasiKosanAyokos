    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-12 text-center" data-aos="fade-up">
                <a href="{{ route('public.kos.index') }}" class="inline-flex items-center px-8 py-4 bg-lime-400 hover:bg-lime-500 text-black font-black border-2 border-black shadow-[4px_4px_0px_#000] hover:shadow-[6px_6px_0px_#000] hover:translate-y-[-2px] transition-all uppercase tracking-wide">

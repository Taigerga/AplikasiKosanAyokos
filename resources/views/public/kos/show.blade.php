        ...
        <nav class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] px-4 py-3" data-aos="fade-down">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm font-bold">
                <li class="inline-flex items-center">
                    <a href="{{ route('public.home') }}" class="text-gray-600 hover:text-black transition">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('public.kos.index') }}" class="text-gray-600 hover:text-black transition">
                            Kos
                        </a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right mx-2 text-gray-400 text-xs"></i>
                        <span class="text-black font-black truncate max-w-xs">{{ $kos->nama_kos }}</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                        <div class="flex-1">
                            <h1 class="text-2xl md:text-3xl font-black text-black mb-2">{{ $kos->nama_kos }}</h1>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-lg font-black text-black mr-2">{{ number_format($averageRating, 1) }}</span>
                                </div>
                                <span class="text-gray-600 font-bold">({{ $totalReviews }} ulasan)</span>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="border-t-2 border-gray-200 pt-4">
                        <div class="flex items-center space-x-4">
                            @if($kos->pemilik->foto_profil)
                                ...
                                @else
                                    <div class="w-12 h-12 bg-pink-400 border-2 border-black flex items-center justify-center">
                                        <span class="text-white font-black text-lg">{{ strtoupper(substr($kos->pemilik->nama, 0, 1)) }}</span>
                                    </div>
                                @endif
                            @else
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm font-bold text-pink-600">{{ $kos->pemilik->nama }}</p>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-gray-700 font-bold">{{ $fasilitas->nama_fasilitas }}</span>
                                </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6" data-aos="fade-up" data-aos-delay="250">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white border-2 border-black p-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                            <div class="flex flex-col lg:flex-row gap-6">
                                <div class="flex-1">
                                    <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                                        <div>
                                            <h3 class="text-xl font-black text-black">Kamar {{ $kamar->nomor_kamar }}</h3>
                                            <div class="flex items-center space-x-3 mt-2">
                                                <span class="text-sm font-bold text-gray-700 bg-gray-100 border-2 border-black px-3 py-1">{{ $kamar->tipe_kamar }}</span>
                                                <span class="text-sm font-bold text-gray-700 bg-gray-100 border-2 border-black px-3 py-1">{{ $kamar->luas_kamar }}</span>
                                                <span class="text-sm font-bold text-gray-700 bg-gray-100 border-2 border-black px-3 py-1">{{ $kamar->kapasitas }} orang</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            @foreach($fasilitasKamar as $fasilitas)
                                                ...
                                                <span class="px-3 py-1 text-xs font-bold bg-gray-100 text-black border-2 border-black">
                                                    <i class="fas fa-check-circle mr-1 text-pink-500"></i> {{ $fasilitas }}
                                                </span>
                                                @endif
                                            @endforeach
                                        </div>
                                ...
                                <div class="lg:text-right lg:border-l-2 lg:border-gray-200 lg:pl-6 lg:min-w-48">
                                    ...
                                    @auth
                                        ...
                                        @endphp
                                        @if($user->role === 'penghuni' && $isAllowed)
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="bg-gray-100 border-2 border-black p-5">
                        <pre class="whitespace-pre-wrap font-sans text-gray-700 font-medium text-sm leading-relaxed">{{ $kos->peraturan }}</pre>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-100 border-2 border-black p-6 mb-8">
                        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                            <div class="text-center md:text-left">
                                <div class="text-5xl font-black text-black mb-2">{{ number_format($averageRating, 1) }}</div>
                                ...
                                <div class="text-gray-600 font-bold">Berdasarkan {{ $totalReviews }} ulasan</div>
                            </div>
                            <div class="w-full md:w-64">
                                ...
                                <div class="flex items-center mb-3">
                                    <span class="text-sm font-bold text-gray-600 w-8">{{ $rating }} <i class="fas fa-star text-yellow-500"></i></span>
                                    <div class="flex-1 bg-white border-2 border-black h-3 mx-3">
                                        <div class="bg-yellow-500 h-full" style="width: {{ $percentage }}%"></div>
                                    </div>
                        ...
                        <div class="border-b-2 border-gray-200 pb-6 last:border-b-0">
                            <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                                <div class="flex items-center space-x-4">
                                    ...
                                    @endif
                                    <div>
                                        <h4 class="font-black text-black">{{ $review->penghuni->nama }}</h4>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    @auth
                                        @php $authPenghuni = auth()->user()->penghuni; @endphp
                                        @if(auth()->user()->role === 'penghuni' && $authPenghuni && $authPenghuni->id_penghuni == $review->id_penghuni)
                            ...
                            <p class="text-gray-700 font-medium leading-relaxed whitespace-pre-line">{{ $review->komentar }}</p>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6" data-aos="fade-left" data-aos-delay="0">
                    ...
                    @if($kos->kamar->min('harga') > 0)
                        <div class="mb-6">
                            ...
                            <p class="text-4xl font-black text-black">Rp {{ number_format($kos->kamar->min('harga'), 0, ',', '.') }}</p>
                            <p class="text-sm font-bold text-gray-600 mt-1">per {{ $kos->tipe_sewa ?? 'bulan' }}</p>
                        </div>
                    @else
                    ...
                    <div class="space-y-3 mb-6 text-sm border-t-2 border-gray-200 pt-4">
                        <div class="flex justify-between"><span class="font-bold text-gray-600">Jenis Kos:</span><span class="font-black text-black capitalize">{{ $kos->jenis_kos }}</span></div>
                        <div class="flex justify-between"><span class="font-bold text-gray-600">Tipe Sewa:</span><span class="font-black text-black capitalize">{{ $kos->tipe_sewa }}</span></div>
                        <div class="flex justify-between"><span class="font-bold text-gray-600">Kamar Tersedia:</span><span class="font-black text-black">{{ $kos->kamar->count() }} kamar</span></div>
                        <div class="flex justify-between"><span class="font-bold text-gray-600">Lokasi:</span><span class="font-black text-black text-right">{{ $kos->kota }}, {{ $kos->provinsi }}</span></div>
                    </div>
                    ...
                    @else
                        <div class="text-center border-t-2 border-gray-200 pt-4">
                            ...
                            <div class="space-y-3">
                                <a href="{{ route('login') }}" class="block w-full px-6 py-3 bg-black text-white font-black border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all uppercase tracking-wide text-sm">Login</a>
                                <a href="{{ route('register') }}" class="block w-full px-6 py-3 bg-yellow-400 text-black font-black border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all uppercase tracking-wide text-sm">Daftar Akun Baru</a>
                            </div>
                        </div>
                    @endif
                    @endauth
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6" data-aos="fade-left" data-aos-delay="100">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="font-black text-black">{{ $kos->alamat }}</p>
                                <p class="font-bold text-gray-600">{{ $kos->kecamatan }}, {{ $kos->kota }} - {{ $kos->kode_pos }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between mt-3">
                            ...
                            <a href="https://www.google.com/maps/dir/?api=1&destination={{ $kos->latitude }},{{ $kos->longitude }}" target="_blank" class="text-emerald-600 hover:text-black font-black text-sm flex items-center">
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="{{ route('public.kos.show', $similar->id_kos) }}" class="block bg-white border-2 border-black p-4 hover:shadow-[3px_3px_0px_#000] transition-shadow">
                            <div class="flex space-x-4">
                                @if($similar->foto_utama)
                                    <img src="{{ asset('storage/' . $similar->foto_utama) }}" alt="{{ $similar->nama_kos }}" class="w-16 h-16 object-cover border-2 border-black flex-shrink-0">
                                @else
                                ...
                                @endif
                                <div class="min-w-0">
                                    <h4 class="font-black text-black text-sm truncate">{{ $similar->nama_kos }}</h4>
...
<div id="contactModal" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white border-4 border-black shadow-[8px_8px_0px_#000] w-full max-w-sm">
        ...
        <div class="p-6 text-center">
            <div class="mb-4">
                @if($kos->pemilik->foto_profil)
                    <img src="{{ url('storage/' . $kos->pemilik->foto_profil) }}" alt="{{ $kos->pemilik->nama }}" class="w-20 h-20 object-cover border-4 border-black mx-auto">
                @else
            ...
            <h5 class="text-xl font-black text-black">{{ $kos->pemilik->nama }}</h5>
            <p class="text-gray-600 font-bold text-sm mb-4">Pemilik {{ $kos->nama_kos }}</p>
            <div class="bg-gray-100 border-2 border-black p-4 mb-4">
                ...
                <p class="text-2xl font-black text-black">{{ $kos->pemilik->no_hp }}</p>
            </div>
            <div class="grid grid-cols-1 gap-3">
                <a href="tel:{{ $kos->pemilik->no_hp }}" class="flex items-center justify-center px-6 py-3 bg-black text-white font-black border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all uppercase tracking-wide text-sm">

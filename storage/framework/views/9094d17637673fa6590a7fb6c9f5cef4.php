<?php $__env->startSection('title', 'Cari Kos - AyoKos'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="mb-8 bg-dark-card border border-dark-border rounded-2xl p-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-4 mt-4 md:mt-0">
                    <div class="text-center">
                        <div class="text-xl font-bold text-white"><?php echo e($kos->total()); ?></div>
                        <div class="text-xs text-slate-400">Total</div>
                    </div>
                    <div class="h-8 w-px bg-slate-700"></div>
                    <div class="text-center">
                        <div class="text-xl font-bold text-green-400">
                            <?php echo e($kos->filter(function($k) { return $k->kamar_tersedia_count > 0; })->count()); ?>
            ...
            <!-- Search Form -->
            <form method="GET" action="<?php echo e(route('public.kos.index')); ?>" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <select name="ketersediaan" 
                            ...
                            <option value="tersedia" <?php echo e(request('ketersediaan') == 'tersedia' ? 'selected' : ''); ?>>Tersedia</option>
                            <option value="penuh" <?php echo e(request('ketersediaan') == 'penuh' ? 'selected' : ''); ?>>Penuh</option>
                        </select>
                    </div>
                    ...
                    <div id="advancedFilters" class="grid grid-cols-1 md:grid-cols-4 gap-4 hidden">
                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                <div class="flex-1">
                                    <input type="number" name="min_harga" value="<?php echo e(request('min_harga')); ?>" 
                                           placeholder="Min" 
                                ...
                                <div class="flex-1">
                                    <input type="number" name="max_harga" value="<?php echo e(request('max_harga')); ?>" 
                                           placeholder="Max" 
                                           class="w-full px-4 py-3 bg-slate-900 border border-slate-700 text-white rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-colors">
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <select name="min_rating" 
                                ...
                                <option value="5" <?php echo e(request('min_rating') == '5' ? 'selected' : ''); ?>>⭐ 5.0</option>
                                <option value="4.5" <?php echo e(request('min_rating') == '4.5' ? 'selected' : ''); ?>>⭐ 4.5+</option>
                                <option value="4" <?php echo e(request('min_rating') == '4' ? 'selected' : ''); ?>>⭐ 4.0+</option>
                                <option value="3.5" <?php echo e(request('min_rating') == '3.5' ? 'selected' : ''); ?>>⭐ 3.5+</option>
                                <option value="3" <?php echo e(request('min_rating') == '3' ? 'selected' : ''); ?>>⭐ 3.0+</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="fasilitas[]" multiple 
                                ...
                                <?php $__currentLoopData = $fasilitasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($fasilitas->id_fasilitas); ?>" 
                                            <?php echo e(in_array($fasilitas->id_fasilitas, $selectedFacilities) ? 'selected' : ''); ?>>
                                        <?php
                                            $iconMap = [
                                                'wifi' => 'wifi',
                                                'laundry' => 'shirt',
                                        ...
                                        ?>
                                        <i class="fas fa-<?php echo e($displayIcon); ?> mr-2"></i>
                        ...
                        <div>
                            ...
                            <select name="sort" 
                                ...
                                <option value="harga_asc" <?php echo e(request('sort') == 'harga_asc' ? 'selected' : ''); ?>>Harga: Rendah ke Tinggi</option>
                                <option value="harga_desc" <?php echo e(request('sort') == 'harga_desc' ? 'selected' : ''); ?>>Harga: Tinggi ke Rendah</option>
                                ...
                                <option value="created_desc" <?php echo e(request('sort') == 'created_desc' ? 'selected' : ''); ?>>Terbaru</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-slate-700">
                        <div class="flex flex-wrap gap-2 items-center">
                            ...
                            <span class="inline-flex items-center bg-blue-900/30 text-blue-300 px-3 py-1.5 rounded-full text-sm">
                                ...
                                <a href="<?php echo e(request()->fullUrlWithQuery(['search' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
                            
                            <?php if(request('jenis_kos')): ?>
                            <span class="inline-flex items-center bg-blue-900/30 text-blue-300 px-3 py-1.5 rounded-full text-sm">
                                <i class="fas fa-users mr-1"></i>
                                <?php echo e(ucfirst(request('jenis_kos'))); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['jenis_kos' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
                            ...
                            <span class="inline-flex items-center bg-green-900/30 text-green-300 px-3 py-1.5 rounded-full text-sm">
                                ...
                                <?php echo e(request('kota')); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['kota' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
                            
                            <?php if(request('ketersediaan')): ?>
                            <span class="inline-flex items-center bg-yellow-900/30 text-yellow-300 px-3 py-1.5 rounded-full text-sm">
                                <i class="fas fa-door-open mr-1"></i>
                                <?php echo e(request('ketersediaan') == 'tersedia' ? 'Tersedia' : 'Penuh'); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['ketersediaan' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
                            
                            <?php if(request('min_harga') || request('max_harga')): ?>
                            <span class="inline-flex items-center bg-yellow-900/30 text-yellow-300 px-3 py-1.5 rounded-full text-sm">
                                <i class="fas fa-money-bill-wave mr-1"></i>
                                <?php if(request('min_harga') && request('max_harga')): ?>
                                    Rp <?php echo e(number_format(request('min_harga'), 0, ',', '.')); ?> - Rp <?php echo e(number_format(request('max_harga'), 0, ',', '.')); ?>

                                <?php elseif(request('min_harga')): ?>
                                    Min. Rp <?php echo e(number_format(request('min_harga'), 0, ',', '.')); ?>

                                <?php elseif(request('max_harga')): ?>
                                    Max. Rp <?php echo e(number_format(request('max_harga'), 0, ',', '.')); ?>

                                <?php endif; ?>
                                <a href="<?php echo e(request()->fullUrlWithQuery(['min_harga' => null, 'max_harga' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
                            ...
                            <span class="inline-flex items-center bg-yellow-900/30 text-yellow-300 px-3 py-1.5 rounded-full text-sm">
                                ...
                                <?php echo e(request('min_rating')); ?>+
                                <a href="<?php echo e(request()->fullUrlWithQuery(['min_rating' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
                            
                            <?php if(request('fasilitas')): ?>
                            <?php
                                $selectedFacilityIds = request('fasilitas', []);
                                $selectedFacilities = $fasilitasList->whereIn('id_fasilitas', $selectedFacilityIds);
                            ?>
                            <?php $__currentLoopData = $selectedFacilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-flex items-center bg-purple-900/30 text-purple-300 px-3 py-1.5 rounded-full text-sm">
                                <?php
                                    ...
                                    $displayIcon = $iconMap[$fasilitas->icon] ?? 'check';
                                ?>
                                <i class="fas fa-<?php echo e($displayIcon); ?> mr-1"></i>
                                <?php echo e($fasilitas->nama_fasilitas); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['fasilitas' => array_diff($selectedFacilityIds, [$fasilitas->id_fasilitas])])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <span class="inline-flex items-center bg-slate-900/30 text-slate-300 px-3 py-1.5 rounded-full text-sm">
                                ...
                                <?php echo e(ucwords(str_replace('_', ' ', request('sort')))); ?>

                                <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => null])); ?>" class="ml-2 hover:text-white">
                                    &times;
                                </a>
                            </span>
                            <?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
            ...
            <div class="bg-slate-800 border border-slate-700 rounded-2xl overflow-hidden transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-xl">
                ...
                <div class="relative h-56 overflow-hidden">
                    <?php if($k->foto_utama): ?>
                        <img src="<?php echo e(asset('storage/' . $k->foto_utama)); ?>" 
                             alt="<?php echo e($k->nama_kos); ?>" 
                    ...
                    <div class="absolute top-4 right-4">
                        <div class="flex items-center bg-yellow-900/80 backdrop-blur-sm px-3 py-1.5 rounded-full">
                            <span class="text-yellow-400 font-bold mr-1"><?php echo e(number_format($averageRating, 1)); ?></span>
                            <i class="fas fa-star text-yellow-400 text-xs"></i>
                            <span class="text-yellow-300 text-xs ml-1">(<?php echo e($reviewCount); ?>)</span>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="p-5 bg-slate-900">
                    <h3 class="text-lg font-semibold text-white mb-2 truncate"><?php echo e($k->nama_kos); ?></h3>
                    
                    <div class="flex items-center text-slate-400 text-sm mb-3">
                        <i class="fas fa-map-marker-alt mr-2 text-blue-400"></i>
                        <span class="truncate"><?php echo e($k->alamat); ?>, <?php echo e($k->kota); ?></span>
                    </div>
                    
                    <!-- Facilities Preview -->
                    <div class="flex flex-wrap gap-2 mb-4">
                        <?php $__currentLoopData = $k->fasilitas->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($k->fasilitas->count() > 3): ?>
                        <span class="px-2 py-1 text-xs rounded-lg bg-slate-700/50 text-slate-400">
                            +<?php echo e($k->fasilitas->count() - 3); ?> lagi
                        </span>
                        <?php endif; ?>
                    </div>
                        ...
                        <div>
                            <?php if($k->kamar_tersedia_count > 0): ?>
                                <span class="text-xl font-bold text-green-400">
                                    Rp <?php echo e(number_format($k->harga_terendah_tersedia, 0, ',', '.')); ?>

                                </span>
                                <p class="text-xs text-slate-400">mulai dari / 
                                    <?php if($k->tipe_sewa == 'harian'): ?>
                                        hari
                                    <?php elseif($k->tipe_sewa == 'mingguan'): ?>
                                        minggu
                                    <?php elseif($k->tipe_sewa == 'bulanan'): ?>
                                        bulan
                                    <?php elseif($k->tipe_sewa == 'tahunan'): ?>
                                        tahun
                                    <?php else: ?>
                                        bulan
                                    <?php endif; ?>
        ...
        <div class="mt-8 bg-slate-800 border border-slate-700 rounded-2xl p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div class="bg-slate-900/50 border border-slate-700 rounded-xl p-4">
                    ...
                    <p class="text-2xl font-bold text-blue-400"><?php echo e($kos->total()); ?></p>
                </div>
                <div class="bg-slate-900/50 border border-slate-700 rounded-xl p-4">
                    ...
                    <p class="text-2xl font-bold text-green-400">
                        ...
                        ?>
                        <?php if($avgPrice): ?>
                            Rp <?php echo e(number_format($avgPrice, 0, ',', '.')); ?>
                ...
                <div class="bg-slate-900/50 border border-slate-700 rounded-xl p-4">
                    ...
                    <p class="text-2xl font-bold text-yellow-400">
                        <?php echo e(number_format($kos->max(function($k) { return $k->reviews->avg('rating'); }) ?? 0, 1)); ?> ⭐
                    </p>
                </div>
                <div class="bg-slate-900/50 border border-slate-700 rounded-xl p-4">
                    <p class="text-sm text-slate-400">Kamar Tersedia</p>
                    <p class="text-2xl font-bold text-purple-400">
                        <?php echo e($kos->sum(function($k) { return $k->kamar->where('status_kamar', 'tersedia')->count(); })); ?>

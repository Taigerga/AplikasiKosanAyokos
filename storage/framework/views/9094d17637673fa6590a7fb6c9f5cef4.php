                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                    ...
                    <div class="flex items-center gap-4 mt-4 md:mt-0">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-white"><?php echo e($kos->total()); ?></div>
                            <div class="text-xs text-slate-400">Total Kos</div>
                        </div>
                        <div class="h-8 w-px bg-slate-600"></div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-emerald-400">
                                <?php echo e($kos->filter(fn($k) => $k->kamar_tersedia_count > 0)->count()); ?>
                            ...
                            <div id="advancedFilters" class="grid grid-cols-1 md:grid-cols-4 gap-4 hidden">
                                ...
                                <div>
                                    ...
                                    <select name="min_rating"
                                        ...
                                        <?php $__currentLoopData = [5, 4.5, 4, 3.5, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($r); ?>" <?php echo e(request('min_rating') == $r ? 'selected' : ''); ?>>⭐ <?php echo e($r); ?>+</option>
                                    ...
                                    <select name="fasilitas[]" multiple
                                        ...
                                        <?php $__currentLoopData = $fasilitasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($fasilitas->id_fasilitas); ?>"
                                                ...
                                                <i class="fas fa-<?php echo e($fasilitas->icon ?? 'check'); ?> mr-2"></i>
                                ...
                                <div>
                                    ...
                                    <select name="sort"
                                        ...
                                        <option value="harga_asc" <?php echo e(request('sort') == 'harga_asc' ? 'selected' : ''); ?>>Harga: Rendah → Tinggi</option>
                                        <option value="harga_desc" <?php echo e(request('sort') == 'harga_desc' ? 'selected' : ''); ?>>Harga: Tinggi → Rendah</option>
                            ...
                            <div class="mt-4 pt-4 border-t border-white/10">
                                <div class="flex flex-wrap gap-2 items-center">
                                    ...
                                    <?php $__currentLoopData = [
                                        ...
                                        <?php if(request($filter[0])): ?>
                                            ...
                                            <span class="inline-flex items-center bg-white/10 text-white px-3 py-1.5 rounded-full text-sm">
                                                <i class="fas fa-<?php echo e($filter[1]); ?> mr-1 opacity-70"></i><?php echo e($filter[3]); ?>

                                                <a href="<?php echo e($removeUrl); ?>" class="ml-2 hover:text-slate-200">&times;</a>
                                            </span>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(request('min_harga') || request('max_harga')): ?>
                                        ...
                                        ?>
                                        <span class="inline-flex items-center bg-white/10 text-white px-3 py-1.5 rounded-full text-sm">
                                            <i class="fas fa-money-bill-wave mr-1 opacity-70"></i><?php echo e($min); ?> <?php echo e($max); ?>
                                    ...
                                    <?php if(request('min_rating')): ?>
                                        <?php $removeUrl = request()->fullUrlWithQuery(['min_rating' => null]); ?>
                                        <span class="inline-flex items-center bg-white/10 text-white px-3 py-1.5 rounded-full text-sm">
                                            <i class="fas fa-star mr-1 opacity-70"></i><?php echo e(request('min_rating')); ?>+
                                            <a href="<?php echo e($removeUrl); ?>" class="ml-2 hover:text-slate-200">&times;</a>
                                        </span>
                                    <?php endif; ?>

                                    <?php if(request('fasilitas')): ?>
                                        <?php $__currentLoopData = $fasilitasList->whereIn('id_fasilitas', request('fasilitas')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            ?>
                                            <span class="inline-flex items-center bg-white/10 text-white px-3 py-1.5 rounded-full text-sm">
                                                <i class="fas fa-check mr-1 opacity-70"></i><?php echo e($f->nama_fasilitas); ?>
                                    ...
                                    <?php if(request('sort')): ?>
                                        ...
                                        ?>
                                        <span class="inline-flex items-center bg-white/10 text-white px-3 py-1.5 rounded-full text-sm">
                                            <i class="fas fa-sort mr-1 opacity-70"></i><?php echo e($sortLabels[request('sort')] ?? ''); ?>

                                            <a href="<?php echo e($removeUrl); ?>" class="ml-2 hover:text-slate-200">&times;</a>
                                        </span>
                                    <?php endif; ?>

                                    <a href="<?php echo e(route('public.kos.index')); ?>" class="text-sm text-sky-300 hover:text-sky-200 ml-auto transition">
    ...
    <section class="py-12 md:py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    ...
                    <div class="relative h-52 overflow-hidden">
                        ...
                        <div class="absolute top-3 right-3 bg-amber-400/90 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-sm font-semibold shadow-sm flex items-center gap-1">
                            ...
                            <span class="text-xs opacity-80">(<?php echo e($reviewCount); ?>)</span>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="p-5 flex flex-col flex-grow">
                        <h3 class="text-lg font-semibold text-slate-900 mb-1 truncate"><?php echo e($k->nama_kos); ?></h3>
                        ...
                        <div class="flex flex-wrap gap-1.5 mb-4">
                            <?php $__currentLoopData = $k->fasilitas->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <span class="px-2.5 py-1 text-xs rounded-full bg-slate-100 text-slate-400 border border-slate-200">
                                +<?php echo e($k->fasilitas->count() - 3); ?>
                            ...
                            <div>
                                <?php if($k->kamar_tersedia_count > 0): ?>
                                    ...
                                    <div class="text-xs text-slate-400">
                                        mulai / <?php echo e($k->tipe_sewa ?? 'bulan'); ?>
            ...
            <div class="mt-10 flex justify-center">
                <?php echo e($kos->onEachSide(2)->links('vendor.pagination.tailwind')); ?>
            ...
            <div class="mt-16 bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <div class="bg-slate-50 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-sky-600"><?php echo e($kos->total()); ?></div>
                    </div>
                    <div class="bg-slate-50 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-emerald-600">
                            ...
                            ?>
                            <?php echo e($avgPrice ? 'Rp '.number_format($avgPrice,0,',','.') : '-'); ?>
                    ...
                    <div class="bg-slate-50 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-amber-500">
                            ...
                            ?>
                            <?php echo e($maxRating ? number_format($maxRating,1).' ⭐' : '-'); ?>
                    ...
                    <div class="bg-slate-50 rounded-xl p-4 text-center">
                        ...
                        <div class="text-2xl font-bold text-indigo-500">
                            <?php echo e($kos->sum(fn($k) => $k->kamar->where('status_kamar','tersedia')->count())); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const hasAdvanced = <?php echo e(request()->hasAny(['min_harga','max_harga','min_rating','fasilitas','sort']) ? 'true' : 'false'); ?>;
        if (hasAdvanced) {
            const filters = document.getElementById('advancedFilters');
            const arrow = document.getElementById('filter-arrow');
            filters.classList.remove('hidden');

                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                    ...
                    <div class="flex items-center gap-4 mt-4 md:mt-0">
                        <div class="text-center bg-black px-4 py-2 border-2 border-black shadow-[2px_2px_0px_#000]">
                            <div class="text-2xl font-black text-white"><?php echo e($kos->total()); ?></div>
                                ...
                                <div class="flex flex-wrap gap-2 items-center">
                                    ...
                                    <?php $__currentLoopData = [
                                        ...
                                        <?php if(request($filter[0])): ?>
                                            <?php $removeUrl = request()->fullUrlWithQuery([$filter[0] => null]); ?>
                                            <span class="inline-flex items-center bg-gray-100 text-black px-3 py-1.5 border-2 border-black font-bold text-sm">
                                                <i class="fas fa-<?php echo e($filter[1]); ?> mr-1"></i><?php echo e($filter[3]); ?>

                                                <a href="<?php echo e($removeUrl); ?>" class="ml-2 hover:text-red-500">&times;</a>
                                            </span>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(request('min_harga') || request('max_harga')): ?>
                                        ...
                                        ?>
                                        <span class="inline-flex items-center bg-gray-100 text-black px-3 py-1.5 border-2 border-black font-bold text-sm">
                                            <i class="fas fa-money-bill-wave mr-1"></i><?php echo e($min); ?> <?php echo e($max); ?>
                                    ...
                                    <?php if(request('min_rating')): ?>
                                        ...
                                        <span class="inline-flex items-center bg-gray-100 text-black px-3 py-1.5 border-2 border-black font-bold text-sm">
                                            <i class="fas fa-star mr-1"></i><?php echo e(request('min_rating')); ?>+
                                            <a href="<?php echo e($removeUrl); ?>" class="ml-2 hover:text-red-500">&times;</a>
                                        </span>
                                    <?php endif; ?>
                                    ...
                                    <?php if(request('fasilitas')): ?>
                                        <?php $__currentLoopData = $fasilitasList->whereIn('id_fasilitas', request('fasilitas')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <span class="inline-flex items-center bg-gray-100 text-black px-3 py-1.5 border-2 border-black font-bold text-sm">
                                                <i class="fas fa-check mr-1"></i><?php echo e($f->nama_fasilitas); ?>
                                    ...
                                    <?php if(request('sort')): ?>
                                        ...
                                        ?>
                                        <span class="inline-flex items-center bg-gray-100 text-black px-3 py-1.5 border-2 border-black font-bold text-sm">
                                            <i class="fas fa-sort mr-1"></i><?php echo e($sortLabels[request('sort')] ?? ''); ?>

                                            <a href="<?php echo e($removeUrl); ?>" class="ml-2 hover:text-red-500">&times;</a>
                                        </span>
                                    <?php endif; ?>

                                    <a href="<?php echo e(route('public.kos.index')); ?>" class="text-sm font-black text-red-500 hover:text-red-600 ml-auto transition-colors">
    ...
    <section class="py-12 md:py-16 bg-white flex-1">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] overflow-hidden transition-transform hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000]" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
                    <!-- Image -->
                    <div class="relative h-52 overflow-hidden border-b-2 border-black">
                        ...
                        <div class="absolute top-3 left-3 flex flex-col gap-1.5">
                            ...
                            <span class="px-3 py-1 text-xs font-black bg-lime-400 text-black border-2 border-black shadow-[1px_1px_0px_#000]">
                                <?php echo e($k->kamar_tersedia_count); ?> Kamar
                            </span>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="p-5 flex flex-col flex-grow">
                        <div class="flex items-start justify-between mb-2">
                            <h3 class="text-lg font-black text-black truncate"><?php echo e($k->nama_kos); ?></h3>
                        </div>
            ...
            <div class="mt-10 flex justify-center">
                <?php echo e($kos->onEachSide(2)->links('vendor.pagination.custom-dark')); ?>
            ...
            <div class="mt-16 bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <div class="bg-gray-100 border-2 border-black p-4 text-center">
                        ...
                        <div class="text-2xl font-black text-pink-600"><?php echo e($kos->total()); ?></div>
                    </div>
                    <div class="bg-gray-100 border-2 border-black p-4 text-center">

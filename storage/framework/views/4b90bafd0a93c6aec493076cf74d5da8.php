...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof window.initAnalisisCharts === 'function') {
        window.initAnalisisCharts({
            ...
            statusKamar: <?php echo json_encode($statusKamar, 15, 512) ?>,
            jenisKos: <?php echo json_encode($jenisKos, 15, 512) ?>,
            statusKontrak: <?php echo json_encode($statusKontrak, 15, 512) ?>,
            reviewData: <?php echo json_encode($reviewData, 15, 512) ?>,
            tipeKamar: <?php echo json_encode($tipeKamar, 15, 512) ?>,
        });
    }
});
</script>

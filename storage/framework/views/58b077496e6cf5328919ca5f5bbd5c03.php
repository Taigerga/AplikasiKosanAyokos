                            ...
                            <div class="flex items-start gap-3 sm:gap-4 min-w-0">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 mb-2">
                                        <div class="min-w-0">
                                            ...
                                            <div class="flex items-center text-xs sm:text-sm text-gray-600 mt-0.5 min-w-0">
                                                ...
                                                <span class="truncate"><?php echo e(optional($review->kos)->alamat ?? '-'); ?>, <?php echo e(optional($review->kos)->kota ?? '-'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center flex-wrap gap-2 sm:gap-3 mb-3">
                                        ...
                                        <span class="text-xs sm:text-sm font-bold text-black"><?php echo e($review->rating); ?>/5</span>
                                        <span class="text-gray-500">•</span>
                                        <span class="text-xs sm:text-sm text-gray-500"><?php echo e($review->created_at->format('d M Y H:i')); ?></span>
                                    </div>
                            ...
                            <div class="flex-1 lg:flex-none bg-gray-100 border-2 border-black p-3 min-w-0">
                                <div class="flex items-center gap-2 min-w-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-xs sm:text-sm font-bold text-black truncate"><?php echo e(optional($review->penghuni)->nama ?? 'Penghuni'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="px-4 sm:px-6 py-4 border-t-2 border-black">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div class="text-sm text-gray-700 text-center sm:text-left">
                            Menampilkan <span class="font-black text-black"><?php echo e($reviews->firstItem()); ?></span> - 
                            <span class="font-black text-black"><?php echo e($reviews->lastItem()); ?></span> dari 
                            <span class="font-black text-black"><?php echo e($reviews->total()); ?></span> ulasan
                        </div>

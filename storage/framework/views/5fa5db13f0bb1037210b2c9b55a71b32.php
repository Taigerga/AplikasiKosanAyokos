                ...
                <div class="profile-menu relative">
                    ...
                    <button class="flex items-center gap-2 p-2 border-2 border-transparent hover:border-black transition-colors">
                        <div class="w-8 h-8 bg-rose-400 border-2 border-black flex items-center justify-center">
                            <span class="text-white font-black"><?php echo e(substr($adminUser->nama ?? $adminUser->name, 0, 1)); ?></span>
                        </div>
                        <span class="text-sm font-bold text-black hidden md:inline"><?php echo e($adminUser->nama ?? $adminUser->name); ?></span>
                    ...
                    <div class="profile-dropdown absolute right-0 w-64 bg-white border-2 border-black shadow-[4px_4px_0px_#000] z-[1001]">
                        <div class="px-4 py-3 border-b-2 border-black">
                            <p class="text-sm font-black text-black"><?php echo e($adminUser->nama ?? $adminUser->name); ?></p>
                            <p class="text-xs font-medium text-gray-600 truncate"><?php echo e($adminUser->email); ?></p>
                        </div>
                        ...
                        <div class="py-1">
                            ...
                            <a href="<?php echo e(route('admin.kontrak.index')); ?>"
                                class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-yellow-100 font-bold text-sm transition-colors">
    ...
    <aside id="sidebar"
        ...
        <nav class="p-4">
            <ul class="space-y-1">
                ...
                <li>
                    <a href="<?php echo e(route('admin.kontrak.index')); ?>"
                        class="flex items-center gap-3 px-3 py-3 font-bold text-sm <?php echo e(request()->routeIs('admin.kontrak.*') ? 'bg-yellow-400 text-black border-l-4 border-yellow-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white border-l-4 border-transparent'); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('admin.pembayaran.index')); ?>"
                        class="flex items-center gap-3 px-3 py-3 font-bold text-sm <?php echo e(request()->routeIs('admin.pembayaran.*') ? 'bg-yellow-400 text-black border-l-4 border-yellow-400' : 'text-gray-400 hover:bg-gray-800 hover:text-white border-l-4 border-transparent'); ?>">

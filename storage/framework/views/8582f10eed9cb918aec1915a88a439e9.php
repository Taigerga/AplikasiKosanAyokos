...
<div class="space-y-6">
    ...
    <div class="space-y-4">
        ...
        <div class="card-hover bg-dark-card border border-dark-border rounded-2xl p-5 transition-all duration-300
            <?php echo e($k->status_kontrak == 'aktif' ? 'hover:border-green-500/50' : 
                ...
                <div class="flex-1">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-4">
                        <div class="flex items-center space-x-3 mb-3 md:mb-0">
                            <div class="w-12 h-12 rounded-xl bg-gradient-to-br 
                                <?php echo e($k->status_kontrak == 'aktif' ? 'from-green-900/30 to-green-800/30' : 
                                ...
                                <i class="fas fa-home 
                                    <?php echo e($k->status_kontrak == 'aktif' ? 'text-green-400' : 
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-3 mt-1">
                                    <span class="px-3 py-1 rounded-full text-xs font-medium
                                        <?php echo e($k->status_kontrak == 'aktif' ? 'bg-green-900/30 text-green-300 border border-green-800/30' : 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div class="bg-dark-bg/50 border border-dark-border rounded-xl p-3">
                            ...
                            <div class="text-xs text-dark-muted"><?php echo e($k->kamar->tipe_kamar); ?></div>
                        </div>
                        ...
                        <div class="bg-dark-bg/50 border border-dark-border rounded-xl p-3">
                            ...
                            <div class="text-white font-medium"><?php echo e($k->durasi_sewa); ?> bulan</div>
                        </div>
                    ...
                    <div class="mt-4 p-4 bg-red-900/20 border border-red-800/30 rounded-xl">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-red-200/80"><?php echo e($k->alasan_ditolak); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>

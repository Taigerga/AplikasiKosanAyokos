                ...
                <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border:4px solid #000;box-shadow:6px 6px 0 #000;max-width:560px;">
                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            <p style="font-size:16px;font-weight:700;color:#000;margin:0 0 16px;">Halo, <?php echo e($nama); ?>!</p>
                            ...
                            <table cellpadding="0" cellspacing="0" style="margin:0 auto 24px;">
                                <tr>
                                    <td style="background:#38bdf8;border:3px solid #000;box-shadow:4px 4px 0 #000;" align="center">
                                        <a href="<?php echo e($url); ?>" style="display:inline-block;padding:14px 36px;color:#000;font-size:16px;font-weight:800;text-decoration:none;">
                                            Reset Password
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="font-size:13px;font-weight:500;color:#6b7280;margin:0;line-height:1.5;">
                                ...
                                <span style="color:#38bdf8;word-break:break-all;"><?php echo e($url); ?></span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="border-top:4px solid #000;padding:20px 40px;text-align:center;">
                            <p style="font-size:12px;font-weight:500;color:#9ca3af;margin:0;">
                                &copy; <?php echo e(date('Y')); ?> AyoKos. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
...
<?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\emails\auth\password-reset.blade.php ENDPATH**/ ?>
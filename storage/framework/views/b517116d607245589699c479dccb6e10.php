...
<body class="bg-gradient-to-br from-slate-900 to-slate-800 text-slate-100 min-h-screen">
    ...
    <?php if(auth()->guard('pemilik')->check() || auth()->guard('penghuni')->check()): ?>
        <!-- Dashboard Layout -->
        <?php echo $__env->renderWhen(auth()->guard('pemilik')->check(), 'layouts.partials.dashboard-pemilik', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        <?php echo $__env->renderWhen(auth()->guard('penghuni')->check(), 'layouts.partials.dashboard-penghuni', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php else: ?>
        <!-- Public Layout -->
                    ...
                    <div class="flex items-center gap-8">
                        ...
                        <nav class="hidden md:flex gap-6">
                            <a href="<?php echo e(route('public.home')); ?>"
                                class="flex items-center gap-2 px-3 py-2 rounded-lg font-medium <?php echo e(request()->routeIs('public.home') ? 'bg-blue-900/30 text-blue-300' : 'text-slate-400 hover:text-slate-100 hover:bg-slate-700/50'); ?>">
                                <i class="fas fa-home w-5"></i>
                                <span>Home</span>
                            </a>
                            <a href="<?php echo e(route('public.kos.index')); ?>"
                                class="flex items-center gap-2 px-3 py-2 rounded-lg font-medium <?php echo e(request()->routeIs('public.kos.index') ? 'bg-blue-900/30 text-blue-300' : 'text-slate-400 hover:text-slate-100 hover:bg-slate-700/50'); ?>">
                                <i class="fas fa-search w-5"></i>
                                <span>Cari Kos</span>
                            </a>
                            <a href="<?php echo e(route('public.kos.peta')); ?>"
                                class="flex items-center gap-2 px-3 py-2 rounded-lg font-medium <?php echo e(request()->routeIs('public.kos.peta') ? 'bg-blue-900/30 text-blue-300' : 'text-slate-400 hover:text-slate-100 hover:bg-slate-700/50'); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-400">
                            <li><a href="<?php echo e(route('public.home')); ?>" class="hover:text-blue-300 transition-colors">Home</a>
                            </li>
                            <li><a href="<?php echo e(route('public.kos.index')); ?>" class="hover:text-blue-300 transition-colors">Cari
                                    Kos</a></li>
                            <li><a href="<?php echo e(route('public.kos.peta')); ?>" class="hover:text-blue-300 transition-colors">Peta
                                    Kos</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-400">
                            <li><a href="<?php echo e(route('public.about')); ?>" class="hover:text-blue-300 transition-colors">Tentang
                                    Kami</a></li>
                            <li><a href="<?php echo e(route('public.howto')); ?>" class="hover:text-blue-300 transition-colors">Cara
                                    Memesan</a></li>
                            <li><a href="<?php echo e(route('public.terms')); ?>" class="hover:text-blue-300 transition-colors">Syarat &
                                    Ketentuan</a></li>
                            <li><a href="<?php echo e(route('public.privacy')); ?>"
        ...
        <div id="successModal" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4">
            ...
            <div class="relative bg-slate-800 border border-slate-700 rounded-2xl w-full max-w-md overflow-hidden">
                <div class="p-6 text-center">
                    ...
                    <p class="text-slate-400"><?php echo e(session('success')); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>

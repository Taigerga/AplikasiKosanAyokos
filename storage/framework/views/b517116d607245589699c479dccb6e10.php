            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-8">
                        <a href="<?php echo e(route('public.home')); ?>" class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg font-medium text-sm">
                        ...
                        <nav class="hidden md:flex gap-4">
                            <a href="<?php echo e(route('public.home')); ?>"
                                class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg font-medium text-sm <?php echo e(request()->routeIs('public.home') ? 'active-link' : ''); ?>">
                                <i class="fas fa-home w-4"></i>
                                <span>Home</span>
                            </a>
                            <a href="<?php echo e(route('public.kos.index')); ?>"
                                class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg font-medium text-sm <?php echo e(request()->routeIs('public.kos.index') ? 'active-link' : ''); ?>">
                                <i class="fas fa-search w-4"></i>
                                <span>Cari Kos</span>
                            </a>
                            <a href="<?php echo e(route('public.kos.peta')); ?>"
                                class="nav-link flex items-center gap-2 px-3 py-2 rounded-lg font-medium text-sm <?php echo e(request()->routeIs('public.kos.peta') ? 'active-link' : ''); ?>">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="btn-masuk">
                            Masuk
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-daftar">
                            Daftar
                        </a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-slate-500 text-sm">
                            <li><a href="<?php echo e(route('public.home')); ?>" class="hover:text-blue-600 transition-colors">Home</a></li>
                            <li><a href="<?php echo e(route('public.kos.index')); ?>" class="hover:text-blue-600 transition-colors">Cari Kos</a></li>
                            <li><a href="<?php echo e(route('public.kos.peta')); ?>" class="hover:text-blue-600 transition-colors">Peta Kos</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-semibold text-slate-900 mb-4 text-sm uppercase tracking-wide">Bantuan</h4>
                        <ul class="space-y-3 text-slate-500 text-sm">
                            <li><a href="<?php echo e(route('public.about')); ?>" class="hover:text-blue-600 transition-colors">Tentang Kami</a></li>
                            <li><a href="<?php echo e(route('public.howto')); ?>" class="hover:text-blue-600 transition-colors">Cara Memesan</a></li>
                            <li><a href="<?php echo e(route('public.terms')); ?>" class="hover:text-blue-600 transition-colors">Syarat & Ketentuan</a></li>
                            <li><a href="<?php echo e(route('public.privacy')); ?>" class="hover:text-blue-600 transition-colors">Kebijakan Privasi</a></li>
                        </ul>
                    </div>
                    <div>
        ...
        <div id="successModal" class="fixed inset-0 z-[9999] hidden items-center justify-center p-4">
            ...
            <div class="relative bg-white border border-slate-200 rounded-2xl w-full max-w-md overflow-hidden shadow-xl">
                <div class="p-6 text-center">
                    ...
                    <p class="text-slate-500"><?php echo e(session('success')); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>

...
<div id="extendModal" class="hidden fixed inset-0 bg-black/70  flex items-center justify-center z-50 p-4">
    <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-8 max-w-md w-full shadow-[4px_4px_0px_#000]">
        ...
        <form action="<?php echo e(route('penghuni.kontrak.extend', $kontrak->id_kontrak)); ?>" method="POST" data-ajax="true" data-ajax-action="/api/penghuni/kontrak/<?php echo e($kontrak->id_kontrak); ?>/extend" data-success-msg="Kontrak berhasil diperpanjang" data-redirect="<?php echo e(route('penghuni.kontrak.show', $kontrak->id_kontrak)); ?>" data-confirm="Apakah Anda yakin ingin memperpanjang kontrak?">
            <?php echo csrf_field(); ?>

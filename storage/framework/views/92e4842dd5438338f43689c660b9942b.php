<?php $__env->startSection('title', 'Detail Aduan - Pemilik AyoKos'); ?>
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li class="inline-flex items-center">
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo e(route('pemilik.aduan.index')); ?>" class="inline-flex items-center text-sm font-bold text-gray-700 hover:text-black transition-colors">
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            ...
            <form method="POST" action="<?php echo e(route('pemilik.aduan.komentar', $aduan->id_aduan)); ?>" enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/pemilik/aduan/<?php echo e($aduan->id_aduan); ?>/komentar" data-success-msg="Komentar berhasil ditambahkan" data-reload="true">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\pemilik\aduan\show.blade.php ENDPATH**/ ?>
        ...
        <div class="bg-dark-card border border-dark-border rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <div class="relative">
                        ...
                        <?php else: ?>
                            <div
                                ...
                                <span
                                    class="text-4xl md:text-5xl text-primary-300 font-bold"><?php echo e(substr($pemilik->nama, 0, 1)); ?></span>
                            </div>
                        <?php endif; ?>
            ...
            <div class="pt-20 md:pt-24 px-4 md:px-8 pb-6 md:pb-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div class="flex-1">
                        <h2 class="text-xl md:text-2xl font-bold text-white"><?php echo e($pemilik->nama); ?></h2>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xl md:text-2xl font-bold text-white"><?php echo e($totalKos); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xl md:text-2xl font-bold text-white"><?php echo e($totalKamar); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xl md:text-2xl font-bold text-white"><?php echo e($kamarTerisi); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-dark-bg/50 p-5 md:p-6 rounded-xl border border-dark-border">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-white">
                                    <?php echo e($pemilik->tanggal_lahir ? \Carbon\Carbon::parse($pemilik->tanggal_lahir)->format('d M Y') : '<span class="text-dark-muted">Belum diisi</span>'); ?>
                    ...
                    <div class="bg-dark-bg/50 p-5 md:p-6 rounded-xl border border-dark-border">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-white">
                                    <?php echo e($pemilik->alamat ?: '<span class="text-dark-muted">Belum diisi</span>'); ?>
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-white">
                                            <span
                                                ...
                                                <?php echo e($pemilik->status_pemilik == 'aktif' ? 'bg-green-900/30 text-green-300' :
                            ...
                            <?php $__currentLoopData = $recentKos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('pemilik.kos.show', $kos->id_kos)); ?>"
                                            ...
                                            <div class="flex justify-between items-start mb-3">
                                                <h4 class="font-semibold text-white truncate"><?php echo e($kos->nama_kos); ?></h4>
                                                <span
                                                    class="text-xs px-2 py-1 rounded-full 
                                                    <?php echo e($kos->status_kos == 'aktif' ? 'bg-green-900/30 text-green-300' :
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            document.getElementById('uploadForm').addEventListener('submit', function (e) {
                ...
                fetch('<?php echo e(route("pemilik.profile.upload-photo")); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {

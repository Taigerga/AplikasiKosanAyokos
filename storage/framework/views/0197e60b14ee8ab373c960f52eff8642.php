        ...
        if (exportBtn) {
            exportBtn.addEventListener('click', async function () {
                ...
                try {
                    ...
                    const statistikData = <?php echo json_encode($statistikRingkasan, 15, 512) ?>;
                    ...
                    for (const chart of charts) {
                        ...
                        if (chart.id === 'statusPembayaranChart') {
                            ...
                            const pembayaranPerBulanData = <?php echo json_encode($pembayaranPerBulan, 15, 512) ?>;
                    ...
                    const riwayatKontrakData = <?php echo json_encode($riwayatKontrak, 15, 512) ?>;
                    ...
                    const tipeKamarDisewaData = <?php echo json_encode($tipeKamarDisewa, 15, 512) ?>;
...
</style><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/penghuni/analisis/pdf-export.blade.php ENDPATH**/ ?>
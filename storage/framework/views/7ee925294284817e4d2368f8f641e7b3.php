                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                            <div class="w-12 h-12 bg-sky-500/20 backdrop-blur-sm border border-sky-500/20 rounded-xl flex items-center justify-center mr-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-4 border-t border-white/10">
                                <div class="text-sm text-slate-100 mb-2 flex items-center">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                        ...
                        <div id="map" class="h-96 w-full rounded-xl border border-white/20 mb-4"></div>
                        
                        <div class="flex items-center justify-between text-sm text-slate-100 bg-white/5 border border-white/20 rounded-lg p-3">
                            <div class="flex items-center">
                                <i class="fas fa-location-dot mr-2 text-orange-400"></i>
    ...
    <script>
                ...
                const customIcon = L.divIcon({
                    html: `
                        <div class="relative">
                            ...
                            <div class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-sky-500 rotate-45"></div>
                        </div>
                    `,
                ...
                document.getElementById('map').innerHTML = `
                    <div class="h-full flex items-center justify-center rounded-xl">
                        <div class="text-center p-8">
                            <div class="w-20 h-20 bg-sky-500/20 backdrop-blur-sm border border-sky-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <i class="fas fa-map text-3xl text-sky-400"></i>
                            </div>
        ...
        function copyCoordinates() {
            ...
            navigator.clipboard.writeText(coords).then(() => {
                ...
                toast.className = 'fixed bottom-4 right-4 bg-green-500/20 backdrop-blur-sm border border-green-500/20 text-white px-4 py-2 rounded-lg shadow-lg z-50 animate-slideIn';
                toast.innerHTML = `
                    <div class="flex items-center">

...
<div class="space-y-6">
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] overflow-hidden">
            <form action="<?php echo e(route('penghuni.profile.update')); ?>" method="POST" class="p-6 md:p-8"
                enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/penghuni/profile/update" data-ajax-method="PUT" data-redirect="<?php echo e(route('penghuni.profile.show')); ?>" data-success-msg="Profil berhasil diperbarui!" data-confirm="Apakah Anda yakin ingin menyimpan perubahan profil?">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $penghuni->nama)); ?>"
                                    class="w-full pl-10 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['nama'];
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="username" name="username"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="jenis_kelamin" name="jenis_kelamin"
                                class="w-full px-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition appearance-none <?php $__errorArgs = ['jenis_kelamin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['tanggal_lahir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="<?php echo e(old('email', $penghuni->email)); ?>"
                                    class="w-full pl-10 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="no_hp" name="no_hp" value="<?php echo e(old('no_hp', $penghuni->no_hp)); ?>"
                                    class="w-full pl-14 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['no_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="alamat" name="alamat" rows="3"
                                class="w-full px-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition resize-none <?php $__errorArgs = ['alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama_bank" name="nama_bank"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['nama_bank'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nomor_rekening" name="nomor_rekening"
                                    ...
                                    class="w-full pl-10 pr-4 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['nomor_rekening'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="password" name="password"
                                    class="w-full pl-10 pr-10 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="w-full pl-10 pr-10 py-3 bg-white border-2 border-black text-black  focus:outline-none focus:shadow-[3px_3px_0px_#000] focus:border-black transition <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);

    ...
    <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-white truncate"><?php echo e($kontrak->kos->nama_kos); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-white">Rp
                                            <?php echo e(number_format($kontrak->harga_sewa, 0, ',', '.')); ?>/bulan
                                        </p>
                                    </div>
                                </div>
        ...
        <?php else: ?>
            ...
            <div class="bg-dark-card border border-dark-border rounded-2xl p-8 text-center">
                ...
                <a href="<?php echo e(route('public.kos.index')); ?>" class="text-blue-400 hover:text-blue-300 text-sm font-medium">
                                ...
                                ($bayar->metode_pembayaran == 'cash' ? 'fa-money-bill' : 'fa-qrcode')); ?> mr-1 text-xs">
                                            ...
                                            <td class="px-6 py-4">
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                                                                                                                    <?php echo e($bayar->status_pembayaran == 'lunas' ? 'bg-green-900/30 text-green-300' :
                                ($bayar->status_pembayaran == 'pending' ? 'bg-yellow-900/30 text-yellow-300' :
                                    ($bayar->status_pembayaran == 'terlambat' ? 'bg-red-900/30 text-red-300' :
                                        'bg-gray-900/30 text-gray-300'))); ?>">
                                                    <i
                                                        class="fas <?php echo e($bayar->status_pembayaran == 'lunas' ? 'fa-check-circle' :

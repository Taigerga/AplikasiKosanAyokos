        ...
        <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="font-black text-black truncate" id="info-kos"><?php echo e($selectedKontrak->kos->nama_kos); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 min-w-0">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="font-black text-black truncate" id="info-kamar"><?php echo e($selectedKontrak->kamar->nomor_kamar); ?>
            ...
            <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
                ...
                <form method="POST" action="<?php echo e(route('penghuni.pembayaran.store')); ?>" enctype="multipart/form-data"
                    id="paymentForm" data-ajax="true" data-ajax-action="/api/penghuni/pembayaran" data-redirect="<?php echo e(route('penghuni.pembayaran.index')); ?>" data-success-msg="Pembayaran berhasil dikirim!" data-confirm="Apakah Anda yakin data pembayaran sudah benar?" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <?php else: ?>
                            ...
                            <div>
                                <label class="block text-sm font-black text-black mb-3">Bayar Berapa <?php echo e($unitLabel); ?>?
                                    *</label>
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                    <?php $__currentLoopData = $paymentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label
                                            ...
                                            <div class="flex-1">
                                                <div class="font-black text-black text-sm"><?php echo e($option['label']); ?></div>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <p class="text-sm text-black font-bold mb-1">Harga/<?php echo e($unitLabel); ?>:</p>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-6">
                            ...
                            <div id="upload-area"
                                class="mt-1 border-2 border-dashed border-black  hover:border-black transition-all duration-200 cursor-pointer bg-gray-100 overflow-hidden <?php $__errorArgs = ['bukti_pembayaran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 focus:ring-rose-500/30 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>">
                        ...
                        <div class="bg-sky-100 border-2 border-black  p-5">
                            ...
                            <ul class="space-y-2">
                                ...
                                <li class="flex items-start text-sm text-black">
                                    ...
                                    <span>Pembayaran pertama sesuai durasi kontrak awal (<strong class="text-black"><?php echo e($selectedKontrak->durasi_sewa); ?> <?php echo e(strtolower($unitLabel)); ?></strong>)</span>
                                </li>
                                <li class="flex items-start text-sm text-black">
                                    <i class="fas fa-redo text-black mr-3 mt-0.5"></i>
                                    <span>Setelah periode ini berakhir, Anda bisa <strong class="text-black">memperpanjang</strong> dengan jumlah <?php echo e(strtolower($unitLabel)); ?> berapa pun</span>
                                </li>
                                <?php else: ?>
                                <li class="flex items-start text-sm text-black">
                                    <i class="fas fa-calendar text-black mr-3 mt-0.5"></i>
                                    <span>Anda dapat membayar maksimal <strong class="text-black"><?php echo e($maxLimit); ?> <?php echo e(strtolower($unitLabel)); ?> ke
                                             depan</strong></span>
                                </li>
                                <?php endif; ?>
                                <li class="flex items-start text-sm text-black">

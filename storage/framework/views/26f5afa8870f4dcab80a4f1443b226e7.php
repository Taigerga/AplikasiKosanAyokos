<?php $__env->startSection('title', 'Data Penghuni - Admin AyoKos'); ?>
...
<div class="p-6">
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
            ...
            <span>></span>
            <span class="font-black text-black">Data Penghuni</span>
        </div>
        <h1 class="text-3xl font-black text-black">Data Penghuni</h1>
    </div>

    <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
        <form method="GET" action="<?php echo e(route('admin.data-penghuni.index')); ?>" class="flex flex-wrap gap-4 mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $dataPenghuni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $penghuni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b-2 border-black hover:bg-gray-50">
                            <td class="px-4 py-3 font-bold"><?php echo e($loop->iteration); ?></td>
                            <td class="px-4 py-3 font-bold"><?php echo e($penghuni->user->name ?? $penghuni->name ?? '-'); ?></td>
                            <td class="px-4 py-3 font-bold"><?php echo e($penghuni->user->email ?? $penghuni->email ?? '-'); ?></td>
                            <td class="px-4 py-3 font-bold"><?php echo e($penghuni->no_hp ?? '-'); ?></td>
                            <td class="px-4 py-3">
                                <?php
                                    $statusColor = [
                                        'aktif' => 'bg-green-300',
                            ...
                            <td class="px-4 py-3 font-bold"><?php echo e(($penghuni->created_at ?? now())->format('d M Y')); ?></td>
                            <td class="px-4 py-3">
                                <a href="<?php echo e(route('admin.data-penghuni.show', $penghuni->id_penghuni)); ?>" class="bg-black text-white font-black px-3 py-1 text-sm border-2 border-black shadow-[3px_3px_0px_#000] hover:shadow-[1px_1px_0px_#000] transition-all inline-block">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="7" class="px-4 py-8 text-center font-bold text-gray-500">Tidak ada data penghuni</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\admin\data-penghuni\index.blade.php ENDPATH**/ ?>
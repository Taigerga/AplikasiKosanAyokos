...
<html>
<head>
    <title><?php echo e($subject ?? 'AyoKos Notification'); ?></title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                <strong>Halo, <?php echo e($userName); ?>!</strong>
            </div>

            <?php if(isset($isCompletion) && $isCompletion): ?>
                <span class="status-badge status-completion">KONTRAK SELESAI</span>
            <?php else: ?>
                <?php if(isset($type) && $type === 'before'): ?>
                    <span class="status-badge status-before">PENGINGAT <?php echo e($daysLeft ?? ''); ?> HARI</span>
                <?php elseif(isset($type) && $type === 'today'): ?>
                    <span class="status-badge status-today">BERAKHIR HARI INI</span>
                <?php elseif(isset($type) && $type === 'overdue'): ?>
                    <span class="status-badge status-overdue">LEWAT <?php echo e($daysLeft ?? ''); ?> HARI</span>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <div class="contract-info">
                ...
                <div class="contract-detail">
                    ...
                    <div class="contract-value"><strong><?php echo e($kosName ?? ''); ?></strong></div>
                </div>

                <div class="contract-detail">
                    <div class="contract-label">Nomor Kamar:</div>
                    <div class="contract-value"><?php echo e($roomNumber ?? 'N/A'); ?></div>
                </div>

                <div class="contract-detail">
                    <div class="contract-label">Tanggal Berakhir:</div>
                    <div class="contract-value"><?php echo e(isset($endDate) ? \Carbon\Carbon::parse($endDate)->format('d F Y') : ''); ?></div>
                </div>

                <?php if(isset($daysLeft) && (!isset($isCompletion) || !$isCompletion)): ?>
                <div class="contract-detail">
                    <div class="contract-label">Sisa Waktu:</div>
                    <div class="contract-value">
                        <?php if($type === 'before'): ?>
                            <strong><?php echo e($daysLeft); ?> hari</strong>
                        <?php elseif($type === 'overdue'): ?>
                            <strong>Terlambat <?php echo e($daysLeft); ?> hari</strong>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="contact-info">
                <p><strong>📞 Kontak <?php echo e(isset($isPemilik) && $isPemilik ? 'Penghuni' : 'Pemilik'); ?>:</strong></p>
                <p><?php echo e($contactInfo ?? 'Silakan cek aplikasi untuk informasi kontak'); ?></p>
            </div>

            <div class="action-buttons">
                <?php if(isset($isPemilik) && $isPemilik): ?>
                    <a href="<?php echo e(url('/pemilik/kontrak')); ?>" class="button">📊 Dashboard Pemilik</a>
                    <a href="<?php echo e(url('/pemilik/kontrak/' . ($contractId ?? ''))); ?>" class="button">👁️ Lihat Kontrak</a>
                <?php else: ?>
                    <a href="<?php echo e(url('/penghuni/kontrak')); ?>" class="button">📋 Kontrak Saya</a>
                    <a href="<?php echo e(url('/penghuni/pembayaran')); ?>" class="button">💳 Pembayaran</a>
                <?php endif; ?>
            </div>
        ...
        <div class="footer">
            <p>© <?php echo e(date('Y')); ?> AyoKos - All rights reserved</p>
            <p>Jl. Contoh No. 123, Kota Bandung | support@ayokos.com</p>
        </div>
    </div>
</body>
</html><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\emails\contract_reminder.blade.php ENDPATH**/ ?>
            ...
            <div class="p-4 md:p-6 border-b-2 border-black
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between">
                    ...
                    <div class="mt-4 md:mt-0 text-right">
                        ...
                        <span class="text-sm text-black font-mono">#PAY-<?php echo e(str_pad($pembayaran->id_pembayaran, 6, '0', STR_PAD_LEFT)); ?></span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center gap-2 min-w-0">
                                    ...
                                    <span class="font-black text-black text-right truncate"><?php echo e($pembayaran->kontrak->kos->nama_kos ?? '-'); ?></span>
                                </div>
                                <div class="flex justify-between items-center gap-2 min-w-0">
                                    <span class="text-gray-600 shrink-0">Alamat</span>
                                    <span class="font-black text-black text-right truncate"><?php echo e($pembayaran->kontrak->kos->alamat ?? '-'); ?></span>
                                </div>
                                <div class="flex justify-between items-center gap-2 min-w-0">
                                    <span class="text-gray-600 shrink-0">Kamar</span>
                                    <span class="font-black text-black text-right">No. <?php echo e($pembayaran->kontrak->kamar->nomor_kamar ?? '-'); ?></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    <div class="w-10 h-10 bg-gray-100 border-2 border-black  flex items-center justify-center">
                                        <i class="fas
                                            <?php echo e($pembayaran->metode_pembayaran == 'transfer' ? 'fa-university' :
                                               ($pembayaran->metode_pembayaran == 'cash' ? 'fa-money-bill-wave' : 'fa-qrcode')); ?>

                                            text-black"></i>
                                    </div>
                                    <div>
                                        <span class="block font-black text-black capitalize"><?php echo e($pembayaran->metode_pembayaran); ?></span>
                                ...
                                <div class="flex justify-between items-center gap-2 min-w-0">
                                    <div class="flex items-center gap-3 min-w-0">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <span class="text-black font-black truncate"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal_jatuh_tempo)->format('d M Y')); ?></span>
                                        </div>
                                    </div>
                                ...
                                <div class="flex justify-between items-center gap-2 min-w-0">
                                    <div class="flex items-center gap-3 min-w-0">
                                        <div class="w-8 h-8 shrink-0 
                                            <?php echo e($pembayaran->tanggal_bayar ? 'bg-emerald-400' : 'bg-gray-100 border-2 border-black'); ?> flex items-center justify-center">
                                            <i class="fas
                                                <?php echo e($pembayaran->tanggal_bayar ? 'fa-check text-emerald-400' : 'fa-clock text-black'); ?>
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <span class="text-black font-black truncate">
                                                <?php echo e($pembayaran->tanggal_bayar ? $pembayaran->tanggal_bayar->format('d M Y H:i') : 'Menunggu pembayaran'); ?>

                                            </span>
                                        </div>
                                    </div>
                                    <span class="text-xs px-2 py-1 shrink-0 border-2 border-black
                                        <?php echo e($pembayaran->tanggal_bayar ? 'bg-emerald-400 text-black' : 'bg-yellow-400 text-black'); ?>">
                                        <?php echo e($pembayaran->tanggal_bayar ? 'Telah Dibayar' : 'Pending'); ?>
                                ...
                                <div class="flex justify-between items-center gap-2 min-w-0">
                                    <div class="flex items-center gap-3 min-w-0">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <span class="text-black font-black truncate"><?php echo e(\Carbon\Carbon::createFromFormat('Y-m', $pembayaran->bulan_tahun)->format('F Y')); ?></span>
                                        </div>
                                    </div>
                        ...
                        <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-start gap-2 min-w-0">
                                    ...
                                    <span class="font-black text-black text-right break-words"><?php echo e($pembayaran->keterangan ?? 'Tidak ada keterangan'); ?></span>
                                </div>
                                <div class="flex justify-between items-start gap-2 min-w-0">
                                    <span class="text-gray-600 shrink-0">Dibuat pada</span>
                                    <span class="font-black text-black text-right"><?php echo e($pembayaran->created_at->format('d M Y H:i')); ?></span>
                                </div>
                                <div class="flex justify-between items-start gap-2 min-w-0">
                                    <span class="text-gray-600 shrink-0">Terakhir diupdate</span>
                                    <span class="font-black text-black text-right"><?php echo e($pembayaran->updated_at->format('d M Y H:i')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                            <div>
                                ...
                                <span class="text-black font-black">bukti_pembayaran_<?php echo e($pembayaran->id_pembayaran); ?>.jpg</span>
                            </div>
                        ...
                        <div class="border-2 border-black  overflow-hidden">
                            <img src="<?php echo e(asset('storage/' . $pembayaran->bukti_pembayaran)); ?>"
            ...
            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                <div class="flex items-center gap-3 min-w-0">
                    <div class="w-10 h-10 shrink-0 bg-gray-100 border-2 border-black flex items-center justify-center">
                        <i class="fas
                            <?php echo e($pembayaran->status_pembayaran == 'lunas' ? 'fa-check-circle text-emerald-400' :
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="font-black text-black truncate"><?php echo e(ucfirst($pembayaran->status_pembayaran)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="font-black text-black truncate">Rp <?php echo e(number_format($pembayaran->jumlah, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="font-black text-black truncate capitalize"><?php echo e($pembayaran->metode_pembayaran); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\penghuni\pembayaran\show.blade.php ENDPATH**/ ?>
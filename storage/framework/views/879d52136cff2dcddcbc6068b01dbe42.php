                        ...
                        <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-black text-black"><?php echo e($pembayaran->kontrak->kos->nama_kos ?? '-'); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Alamat</span>
                                    <span class="font-black text-black text-right"><?php echo e($pembayaran->kontrak->kos->alamat ?? '-'); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Kamar</span>
                                    <span class="font-black text-black">No. <?php echo e($pembayaran->kontrak->kamar->nomor_kamar ?? '-'); ?></span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="text-black font-black"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal_jatuh_tempo)->format('d M Y')); ?></span>
                                        </div>
                                    </div>
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="text-black font-black"><?php echo e(\Carbon\Carbon::createFromFormat('Y-m', $pembayaran->bulan_tahun)->format('F Y')); ?></span>
                                        </div>
                                    </div>
                        ...
                        <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-start">
                                    ...
                                    <span class="font-black text-black text-right"><?php echo e($pembayaran->keterangan ?? 'Tidak ada keterangan'); ?></span>
                                </div>
                                <div class="flex justify-between items-start">
                                    <span class="text-gray-600">Dibuat pada</span>
                                    <span class="font-black text-black"><?php echo e($pembayaran->created_at->format('d M Y H:i')); ?></span>
                                </div>
                                <div class="flex justify-between items-start">
                                    <span class="text-gray-600">Terakhir diupdate</span>
                                    <span class="font-black text-black"><?php echo e($pembayaran->updated_at->format('d M Y H:i')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        ...
                        <span class="font-black text-black"><?php echo e(ucfirst($pembayaran->status_pembayaran)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        ...
                        <span class="font-black text-black">Rp <?php echo e(number_format($pembayaran->jumlah, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-5">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        ...
                        <span class="font-black text-black capitalize"><?php echo e($pembayaran->metode_pembayaran); ?></span>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div class="border-b-2 border-black">
            <nav class="grid grid-cols-2 md:grid-cols-4">
                <button onclick="showTab('pending')" 
                        class="tab-button px-2 sm:px-6 py-3 md:py-4 border-b-2 font-bold text-xs sm:text-sm transition-all duration-300 <?php echo e(request('tab', 'pending') === 'pending' ? 'border-yellow-400 text-black bg-yellow-200' : 'border-transparent text-gray-500 hover:text-black hover:bg-gray-100'); ?>"
                        id="tab-pending">
                    <div class="flex items-center justify-center flex-wrap gap-1">
                        <i class="fas fa-clock <?php echo e(request('tab', 'pending') === 'pending' ? 'text-black' : 'text-gray-400'); ?>"></i>
                        <span>Pending</span>
                ...
                <button onclick="showTab('aktif')" 
                        class="tab-button px-2 sm:px-6 py-3 md:py-4 border-b-2 font-bold text-xs sm:text-sm transition-all duration-300 <?php echo e(request('tab') === 'aktif' ? 'border-yellow-400 text-black bg-yellow-200' : 'border-transparent text-gray-500 hover:text-black hover:bg-gray-100'); ?>"
                        id="tab-aktif">
                    <div class="flex items-center justify-center flex-wrap gap-1">
                        <i class="fas fa-check-circle <?php echo e(request('tab') === 'aktif' ? 'text-black' : 'text-green-400'); ?>"></i>
                        <span>Aktif</span>
                ...
                <button onclick="showTab('selesai')" 
                        class="tab-button px-2 sm:px-6 py-3 md:py-4 border-b-2 font-bold text-xs sm:text-sm transition-all duration-300 <?php echo e(request('tab') === 'selesai' ? 'border-yellow-400 text-black bg-yellow-200' : 'border-transparent text-gray-500 hover:text-black hover:bg-gray-100'); ?>"
                        id="tab-selesai">
                    <div class="flex items-center justify-center flex-wrap gap-1">
                        <i class="fas fa-history <?php echo e(request('tab') === 'selesai' ? 'text-black' : 'text-yellow-400'); ?>"></i>
                        <span>Selesai</span>
                ...
                <button onclick="showTab('ditolak')" 
                        class="tab-button px-2 sm:px-6 py-3 md:py-4 border-b-2 font-bold text-xs sm:text-sm transition-all duration-300 <?php echo e(request('tab') === 'ditolak' ? 'border-yellow-400 text-black bg-yellow-200' : 'border-transparent text-gray-500 hover:text-black hover:bg-gray-100'); ?>"
                        id="tab-ditolak">
                    <div class="flex items-center justify-center flex-wrap gap-1">
                        <i class="fas fa-times-circle <?php echo e(request('tab') === 'ditolak' ? 'text-black' : 'text-red-400'); ?>"></i>
                        <span>Ditolak</span>
                    ...
                    <div class="bg-gray-100 border-2 border-black p-5 w-full overflow-hidden hover:shadow-[3px_3px_0px_#000] transition-all duration-300">
                        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                            ...
                            <div class="flex items-start gap-4 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <h3 class="font-bold text-black truncate"><?php echo e($kontrak->penghuni->nama ?? 'N/A'); ?></h3>
                                    <p class="text-sm text-gray-600 truncate"><?php echo e($kontrak->penghuni->no_hp ?? '-'); ?></p>
                            ...
                            <div class="lg:text-center min-w-0">
                                <div class="text-sm font-bold text-black truncate"><?php echo e($kontrak->kos->nama_kos ?? 'N/A'); ?></div>

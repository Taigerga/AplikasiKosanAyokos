<?php $__env->startSection('title', 'Syarat & Ketentuan - AyoKos'); ?>
        ...
        <div class="bg-lime-100 border-2 border-black p-6 md:p-8" data-aos="fade-up">
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                <div class="text-center md:text-right shrink-0">
                    ...
                    <p class="text-xs font-black text-gray-600 mt-1">Terakhir diperbarui: <?php echo e(date('d F Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/public/pages/terms.blade.php ENDPATH**/ ?>
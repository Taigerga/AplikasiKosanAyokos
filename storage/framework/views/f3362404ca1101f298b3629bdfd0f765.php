                        ...
                        <?php $__currentLoopData = $aduans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $aduan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-4 text-center">
                                    <a href="<?php echo e(route('pemilik.aduan.show', $aduan->id_aduan)); ?>" class="inline-flex items-center px-3 py-2 bg-sky-400 hover:bg-sky-500 text-black font-black text-sm border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all">

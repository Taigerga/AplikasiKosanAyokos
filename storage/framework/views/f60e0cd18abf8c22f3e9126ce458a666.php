                                        ...
                                        <tr class="hover:bg-dark-bg/30 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex items-center px-3 py-1.5 text-xs font-semibold rounded-full 
                                                    <?php echo e($item->status_kamar == 'tersedia' ? 'bg-green-900/30 text-green-300 border border-green-700/30' :
            ...
            <div class="px-6 py-4 border-t border-dark-border">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-dark-muted">
                        Menampilkan <?php echo e($kamar->firstItem()); ?> - <?php echo e($kamar->lastItem()); ?> dari <?php echo e($kamar->total()); ?> kamar
                    </div>
    ...
    <div class="mt-8 flex justify-between items-center">
        ...
        <?php if($kamar->count() > 0): ?>
            <div class="text-sm text-dark-muted">
                ...
                Menampilkan <?php echo e($kamar->count()); ?> kamar
            </div>
        <?php endif; ?>
    </div>
    </div>

<?php $__env->startSection('title', 'AyoKos - Tempat Cari Kos Terbaik'); ?>
    ...
    <section class="relative py-16 md:py-24 overflow-hidden bg-animate section-padding">
        ...
        <div class="container mx-auto px-4 text-center relative z-10 container-padding">
            <div class="max-w-3xl mx-auto">
                ...
                <form action="<?php echo e(route('public.kos.index')); ?>" method="GET" class="max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mt-8 md:mt-12 max-w-2xl mx-auto hero-stats">
                    <div class="text-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                        <div class="text-xl md:text-3xl font-bold text-white mb-1"><?php echo e($totalKos ?? '100+'); ?></div>
                        <div class="text-xs md:text-sm text-primary-200">Kos Tersedia</div>
                    </div>
                    <div class="text-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                        <div class="text-xl md:text-3xl font-bold text-white mb-1"><?php echo e($totalKamar ?? '500+'); ?></div>
                        <div class="text-xs md:text-sm text-primary-200">Kamar Kosong</div>
                    </div>
                    <div class="text-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                        <div class="text-xl md:text-3xl font-bold text-white mb-1"><?php echo e($kotaTerdaftar ?? '20+'); ?></div>
                        <div class="text-xs md:text-sm text-primary-200">Kota</div>
                    </div>
                    <div class="text-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl">
                        <div class="text-xl md:text-3xl font-bold text-white mb-1"><?php echo e($penghuniAktif ?? '1000+'); ?></div>
                ...
                <div class="card-hover bg-dark-card border border-dark-border rounded-2xl overflow-hidden transition-all duration-300 kos-card">
                    ...
                    <div class="relative h-48 md:h-56 overflow-hidden kos-image">
                        <?php if($kos->foto_utama): ?>
                            ...
                            <?php if($fileExists): ?>
                                <img src="<?php echo e(url('storage/' . $kos->foto_utama)); ?>" 
                    ...
                    <div class="p-4 md:p-5">
                        <div class="flex items-start justify-between mb-2 md:mb-3">
                            <h3 class="text-base md:text-lg font-semibold text-white truncate kos-title"><?php echo e($kos->nama_kos); ?></h3>
                            <div class="flex items-center text-yellow-400 text-sm">
                                ...
                                <?php if($ratingKos): ?>
                                    ...
                                    <span class="text-xs md:text-sm"><?php echo e(number_format($ratingKos, 1)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center text-dark-muted text-xs md:text-sm mb-3 md:mb-4">
                            ...
                            <span class="truncate"><?php echo e(Str::limit($kos->alamat, 40)); ?></span>
                        </div>
                        ...
                        <div class="flex gap-2 mb-4 md:mb-5 overflow-x-auto pb-2 kos-facilities">
                            ...
                            <span class="px-2 py-1 text-xs rounded-lg bg-dark-border/50 text-dark-muted whitespace-nowrap facility-badge">
                                <i class="fas fa-<?php echo e($fasilitasItem->icon ?? 'check'); ?> mr-1"></i>
                                <?php echo e(Str::limit($fasilitasItem->nama_fasilitas, 15)); ?>

                            </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($kos->fasilitas->count() > 3): ?>
                            <span class="px-2 py-1 text-xs rounded-lg bg-dark-border/50 text-dark-muted whitespace-nowrap facility-badge">
                                +<?php echo e($kos->fasilitas->count() - 3); ?> lagi
                            </span>
                            <?php endif; ?>
                        </div>

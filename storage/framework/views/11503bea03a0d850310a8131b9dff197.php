            ...
            <div class="flex flex-col md:flex-row items-start gap-6 md:gap-10 relative" data-aos="fade-up">
                ...
                <div class="flex-1 w-full">
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm card-hover">
                        ...
                        <a href="<?php echo e(route('public.kos.index')); ?>" class="inline-flex items-center px-5 py-2.5 bg-sky-600 hover:bg-sky-700 text-white rounded-xl font-medium transition shadow-sm text-sm">

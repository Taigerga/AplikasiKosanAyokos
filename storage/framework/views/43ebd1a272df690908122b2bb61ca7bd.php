    ...
    <div class="container mx-auto px-4 relative z-10 text-center" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10" data-aos="fade-up" data-aos-delay="0">
                <div class="text-3xl md:text-4xl font-bold text-white mb-1"><?php echo e($kos->count()); ?></div>
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10" data-aos="fade-up" data-aos-delay="100">
                <div class="text-3xl md:text-4xl font-bold text-white mb-1"><?php echo e($kos->where('jenis_kos', 'putra')->count()); ?></div>
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10" data-aos="fade-up" data-aos-delay="200">
                <div class="text-3xl md:text-4xl font-bold text-white mb-1"><?php echo e($kos->where('jenis_kos', 'putri')->count()); ?></div>
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10" data-aos="fade-up" data-aos-delay="300">
                <div class="text-3xl md:text-4xl font-bold text-white mb-1"><?php echo e($kos->where('jenis_kos', 'campuran')->count()); ?></div>
            ...
            <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm lg:col-span-1 card-hover" data-aos="fade-right">
                ...
                <div class="mt-6 pt-6 border-t border-slate-100">
                    ...
                    <div class="space-y-3">
                        ...
                        <?php elseif(auth()->guard('pemilik')->check()): ?>
                ...
                <?php $__currentLoopData = $kos->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white border border-slate-200 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 card-hover">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <h3 class="font-semibold text-slate-900"><?php echo e($k->nama_kos); ?></h3>
                                <p class="text-sm text-slate-500 mt-1"><?php echo e($k->alamat); ?></p>
                                <div class="flex items-center gap-4 mt-2">
                                    <span class="text-xs px-2.5 py-1 rounded-full 
                                        <?php echo e($k->jenis_kos == 'putra' ? 'bg-blue-50 text-blue-700 border border-blue-100' :
                                            ($k->jenis_kos == 'putri' ? 'bg-pink-50 text-pink-700 border border-pink-100' :
                                                'bg-purple-50 text-purple-700 border border-purple-100')); ?>">
                                        <?php echo e(ucfirst($k->jenis_kos)); ?>

                                    </span>
                                    <span class="text-xs text-slate-400"><?php echo e($k->kamar_count ?? 0); ?> Kamar</span>
                                </div>
                            </div>

<div class="text-center py-12 <?php echo e($class ?? ''); ?>">
    <div class="text-5xl mb-4">⚠️</div>
    <h3 class="text-lg font-bold mb-2"><?php echo e($title ?? 'Terjadi Kesalahan'); ?></h3>
    <p class="text-gray-600 mb-6"><?php echo e($message ?? 'Gagal memuat data. Silakan coba lagi.'); ?></p>
    <?php if($showRetry ?? true): ?>
...
<?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\components\error-state.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <div class="content">
        <p>Hai <strong><?php echo e($userName ?? 'Pengguna'); ?></strong>,</p>
        
        <p><?php echo $emailMessage; ?></p>
        
        <div class="payment-info <?php echo e($type == 'pending_penghuni' ? 'status-pending' : ($type == 'approved_penghuni' ? 'status-approved' : 'status-rejected')); ?>">
        ...
        <?php if($type == 'rejected_penghuni'): ?>
            <p>Silakan login ke akun Anda untuk mengupload ulang bukti pembayaran yang valid.</p>
            <a href="<?php echo e(url('/penghuni/login')); ?>" class="btn">Login ke AyoKos</a>
        <?php elseif($type == 'pending_penghuni'): ?>
...
</html><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/emails/penghuni/pembayaran_notification.blade.php ENDPATH**/ ?>
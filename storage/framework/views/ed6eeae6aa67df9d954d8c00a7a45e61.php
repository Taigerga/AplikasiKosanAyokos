                ...
                <div class="flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div class="bg-gray-100 border-2 border-black p-3">
                            ...
                            <div class="text-black font-black break-words"><?php echo e($k->kamar->nomor_kamar); ?></div>
                            <div class="text-xs text-gray-600 break-words"><?php echo e($k->kamar->tipe_kamar); ?></div>
                        </div>

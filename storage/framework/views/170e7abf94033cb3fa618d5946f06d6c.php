            ...
            <div class="card-hover bg-dark-card border border-dark-border rounded-xl p-5">
                <div class="flex items-center justify-between mb-4">
                    <div class="p-3 rounded-lg 
                        <?php echo e($user->status_penghuni == 'aktif' ? 'bg-blue-900/30' :
        ($user->status_penghuni == 'calon' ? 'bg-yellow-900/30' : 'bg-red-900/30')); ?>">
                        <i
                            class="fas 
                            <?php echo e($user->status_penghuni == 'aktif' ? 'fa-check-circle text-blue-400' :
        ($user->status_penghuni == 'calon' ? 'fa-clock text-yellow-400' : 'fa-times-circle text-red-400')); ?> text-xl"></i>
                    </div>
                    <span
                        class="text-sm font-medium px-2 py-1 rounded-full 
                        <?php echo e($user->status_penghuni == 'aktif' ? 'bg-blue-900/20 text-blue-300' :
            ...
            <div class="card-hover bg-dark-card border border-dark-border rounded-xl p-5">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-sm font-medium px-2 py-1 rounded-full 
                        <?php echo e($berakhirSegera > 0 ? 'bg-orange-900/20 text-orange-300' : 'bg-green-900/20 text-green-300'); ?>">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-3">
                                                ...
                                                <span class="text-xs px-2 py-1 rounded-full 
                                                    <?php echo e($kontrak->statusWarna == 'green' ? 'bg-green-900/30 text-green-300' :
                            ($kontrak->statusWarna == 'yellow' ? 'bg-yellow-900/30 text-yellow-300' :
                                ($kontrak->statusWarna == 'red' ? 'bg-red-900/30 text-red-300' :
                                    'bg-gray-900/30 text-gray-300'))); ?>">
                                            ...
                                            <p class="text-sm text-dark-muted mb-3">Kamar <?php echo e($kontrak->kamar->nomor_kamar); ?></p>
                                            ...
                                            <div class="flex items-center justify-between text-sm">
                                                ...
                                                <span class="font-bold text-white">
                                                    Rp <?php echo e(number_format($kontrak->harga_sewa, 0, ',', '.')); ?>/bulan
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <div class="w-10 h-10 rounded-full 
                                            <?php echo e($pembayaran->status_pembayaran == 'lunas' ? 'bg-green-900/30' :
                                ...
                                ($pembayaran->status_pembayaran == 'terlambat' ? 'bg-red-900/30' :
                                    'bg-gray-900/30'))); ?> flex items-center justify-center">
                                            <i class="fas fa-<?php echo e($pembayaran->status_pembayaran == 'lunas' ? 'check' : 'clock'); ?> 
                                                <?php echo e($pembayaran->status_pembayaran == 'lunas' ? 'text-green-400' :
                                ...
                                ($pembayaran->status_pembayaran == 'terlambat' ? 'text-red-400' :
                                    'text-gray-400'))); ?>"></i>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-dark-muted"><?php echo e($pembayaran->bulan_tahun); ?></p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-bold text-white">Rp <?php echo e(number_format($pembayaran->jumlah, 0, ',', '.')); ?></p>
                                        <span class="inline-block px-2 py-1 text-xs rounded-full 
                                            <?php echo e($pembayaran->status_pembayaran == 'lunas' ? 'bg-green-900/30 text-green-300' :
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $kontrakBerakhirSegera->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontrak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-orange-900/10 border border-orange-800/30 rounded-xl p-4">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h3 class="font-semibold text-white mb-2"><?php echo e($kontrak->kos->nama_kos); ?></h3>
                                        <p class="text-sm text-dark-muted mb-2">Kamar <?php echo e($kontrak->kamar->nomor_kamar); ?></p>
                    ...
                    <div class="bg-dark-bg/50 border border-dark-border rounded-xl p-4">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="px-3 py-1 rounded-full text-sm font-medium
                                <?php echo e($user->status_penghuni == 'aktif' ? 'bg-green-900/30 text-green-300' :

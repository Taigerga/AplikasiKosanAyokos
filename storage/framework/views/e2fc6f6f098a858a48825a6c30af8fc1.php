...
<?php $__env->startSection('content'); ?>
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="<?php echo e(route('penghuni.dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-dark-muted hover:text-white transition-colors">
                    ...
                    <li class="inline-flex items-center">
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo e(route('penghuni.analisis.index')); ?>" class="inline-flex items-center text-sm font-medium text-white">
            ...
            <div class="bg-gradient-to-br from-primary-600/20 to-indigo-600/20 border border-primary-500/30 rounded-2xl p-5 card-hover">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($statistikRingkasan['total_kontrak']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-yellow-600/20 to-amber-600/20 border border-yellow-500/30 rounded-2xl p-5 card-hover">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($statistikRingkasan['jumlah_review']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-2xl p-5 card-hover">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e(number_format($statistikRingkasan['rata_rata_rating'], 1)); ?>/5</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php $__currentLoopData = $statusPembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center p-2 bg-dark-bg/30 rounded-lg">
                            <div class="inline-block w-2 h-2 rounded-full mb-1
                                <?php if($status->status_pembayaran == 'lunas'): ?> bg-green-500
                                <?php elseif($status->status_pembayaran == 'pending'): ?> bg-yellow-500
                                <?php elseif($status->status_pembayaran == 'terlambat'): ?> bg-red-500
                        ...
                        <tbody class="divide-y divide-dark-border">
                            <?php $__currentLoopData = $riwayatKontrak->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontrak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-dark-border/30 transition">
                                    <td class="px-4 py-3">
                                        <div class="text-sm font-medium text-white"><?php echo e($kontrak->kos->nama_kos); ?></div>
                                        <div class="text-xs text-dark-muted">Kamar <?php echo e($kontrak->kamar->nomor_kamar); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-white"><?php echo e($kontrak->durasi_sewa); ?> bulan</div>
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 text-xs rounded-full 
                                            <?php echo e($kontrak->status_kontrak == 'aktif' ? 'bg-green-900/30 text-green-300' : 
                    ...
                    <table class="min-w-full divide-y divide-dark-border">
                        ...
                        <tbody class="divide-y divide-dark-border">
                            <?php $__currentLoopData = $tipeKamarDisewa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-dark-border/30 transition">
                                    <td class="px-4 py-3">
                                        <div class="text-sm font-medium text-white"><?php echo e($tipe->tipe_kamar); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-white"><?php echo e($tipe->jumlah_sewa); ?> kali</div>
                                    </td>
                                    <td class="px-4 py-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-primary-900/20 border border-primary-500/30 p-4 rounded-xl">
                    ...
                    <p class="text-sm text-dark-muted">
                        ...
                        <span class="font-bold text-primary-300"><?php echo e($kosFavorit->jenis_kos ?? '-'); ?></span> 
                ...
                <div class="bg-purple-900/20 border border-purple-500/30 p-4 rounded-xl">
                    ...
                    <p class="text-sm text-dark-muted">
                        Tipe kamar favorit: 
                        <span class="font-bold text-purple-300"><?php echo e($tipeFavorit->tipe_kamar ?? '-'); ?></span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Data dari PHP
            const pengeluaranData = <?php echo json_encode($pembayaranPerBulan, 15, 512) ?>;
            const statusPembayaranData = <?php echo json_encode($statusPembayaran, 15, 512) ?>;
            const jenisKosData = <?php echo json_encode($jenisKosDisewa, 15, 512) ?>;
            const reviewData = <?php echo json_encode($reviewStats, 15, 512) ?>;
            const durasiData = <?php echo json_encode($durasiTinggal, 15, 512) ?>;
            const tipeKamarData = <?php echo json_encode($tipeKamarDisewa, 15, 512) ?>;
...
<?php echo $__env->make('penghuni.analisis.pdf-export', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            ...
                            <?php $__currentLoopData = $riwayatKontrak->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontrak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-white/5 transition">
                                    <td class="px-4 py-3">
                                        ...
                                        <div class="text-xs text-white/60">Kamar <?php echo e($kontrak->kamar->nomor_kamar); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-white"><?php echo e($kontrak->durasi_sewa); ?> <?php echo e($kontrak->unit_label_lower); ?></div>
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 text-xs rounded-full
                                            <?php echo e($kontrak->status_kontrak == 'aktif' ? 'bg-emerald-50 text-emerald-600' :
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-4">
                    ...
                    <p class="text-sm text-white/60">
                        ...
                        <span class="font-bold text-emerald-400"><?php echo e($kosFavorit->jenis_kos ?? '-'); ?></span>
                ...
                <div class="bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-4">
                    ...
                    <p class="text-sm text-white/60">
                        Tipe kamar favorit:
                        <span class="font-bold text-emerald-400"><?php echo e($tipeFavorit->tipe_kamar ?? '-'); ?></span>

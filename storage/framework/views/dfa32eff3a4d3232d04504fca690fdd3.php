        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div class="hidden md:flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg font-black text-black">Dashboard Pemilik</h1>
                        <p class="text-xs font-bold text-gray-500">Kelola properti Anda</p>
                    </div>
                </div>
            </div>
...
<div class="flex min-h-[calc(100vh-64px)] relative">
    ...
    <aside id="sidebar"
        ...
        <div class="p-4 border-t-2 border-gray-800 mt-4">
            <div class="text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider">Statistik Cepat</div>
            <div class="space-y-2">

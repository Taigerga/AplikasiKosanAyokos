                    ...
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-6 mb-8 border border-white/10">
                        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                            <div class="text-center md:text-left">
                                ...
                                <div class="text-slate-400">Berdasarkan <?php echo e($totalReviews); ?> ulasan</div>
                            </div>
                            <div class="w-full md:w-64">
                                ...
                                <div class="flex items-center mb-3">
                                    <span class="text-sm text-slate-400 w-8"><?php echo e($rating); ?> <i class="fas fa-star text-amber-500"></i></span>
                                    ...
                                    <span class="text-sm text-slate-400 w-8 text-right"><?php echo e($count); ?></span>
                                </div>
                                <?php endfor; ?>
                            </div>
                        </div>
                        ...
                        <div class="border-b border-white/20 pb-6 last:border-b-0">
                            <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <?php if(auth()->guard('penghuni')->check()): ?>
                                        <?php $authPenghuni = Auth::guard('penghuni')->user()->penghuni; ?>
                                        <?php if($authPenghuni && $authPenghuni->id_penghuni == $review->id_penghuni): ?>
                            ...
                            <p class="text-slate-300 leading-relaxed whitespace-pre-line"><?php echo e($review->komentar); ?></p>

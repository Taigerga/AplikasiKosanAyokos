                    ...
                    <div class="role-selection">
                        <div class="role-card <?php if(old('role') == 'penghuni'): ?> active <?php endif; ?>" onclick="selectRole('penghuni')">
                            <input type="radio" name="role" value="penghuni" 
                                   id="rolePenghuni" <?php echo e(old('role') == 'penghuni' ? 'checked' : ''); ?> hidden>
                        ...
                        <div class="role-card <?php if(old('role') == 'pemilik'): ?> active <?php endif; ?>" onclick="selectRole('pemilik')">
                            <input type="radio" name="role" value="pemilik" 
                                   id="rolePemilik" <?php echo e(old('role') == 'pemilik' ? 'checked' : ''); ?> hidden>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-4 text-center pt-3">
                    <a href="<?php echo e(route('public.home')); ?>" class="text-decoration-none fw-semibold text-primary-emphasis">
...
</html><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/auth/login.blade.php ENDPATH**/ ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-black text-black"><?php echo e($kos->nama_kos); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-black text-black"><?php echo e($kos->alamat); ?>, <?php echo e($kos->kota); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-black text-black"><?php echo e(ucfirst($kos->jenis_kos)); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center">
...
<span class="px-3 py-1 text-xs font-black bg-emerald-400 text-black border-2 border-black">
            ...
            <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
                ...
                <form method="POST" action="<?php echo e(route('penghuni.kontrak.store')); ?>" enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/penghuni/kontrak" data-redirect="<?php echo e(route('penghuni.dashboard')); ?>" data-success-msg="Pengajuan kos berhasil dikirim!" data-confirm="Apakah Anda yakin data pengajuan kontrak sudah benar?" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="id_kamar" name="id_kamar"
                                class="w-full px-4 py-3 bg-gray-100 border-2 border-black text-black  focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30 transition <?php $__errorArgs = ['id_kamar'];
                        ...
                        <div class="border-t border-black pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="bg-gray-100 border-2 border-black p-4">
                                    ...
                                    <p class="font-black text-black"><?php echo e(auth()->user()->penghuni->no_hp); ?></p>

                                </div>
                                <div class="bg-gray-100 border-2 border-black p-4">
                                    <p class="text-sm text-gray-600 mb-1">Email</p>
                                    <p class="font-black text-black"><?php echo e(auth()->user()->penghuni->email); ?></p>
                        ...
                        <div class="border-t border-black pt-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div
                                        class="border-2 border-dashed border-black  p-6 text-center hover:border-black transition <?php $__errorArgs = ['foto_ktp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 focus:ring-rose-500/30 <?php unset($message);
                            ...
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-black text-black mt-1"><?php echo e(auth()->user()->penghuni->email); ?>

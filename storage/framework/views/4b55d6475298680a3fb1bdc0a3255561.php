<?php $__env->startSection('title', 'Buat Aduan - Pemilik AyoKos'); ?>
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            <form method="POST" action="<?php echo e(route('pemilik.aduan.store')); ?>" enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/pemilik/aduan" data-redirect="<?php echo e(route('pemilik.aduan.index')); ?>" data-success-msg="Aduan berhasil dikirim!">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/pemilik/aduan/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Beri Review - AyoKos'); ?>
    ...
    <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] overflow-hidden">
        ...
        <div class="bg-gray-100 border-b-2 border-black p-6">
            <div class="text-center">
                ...
                <h2 class="text-xl text-emerald-400 font-black"><?php echo e($kos->nama_kos); ?></h2>
        ...
        <div class="p-6">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('penghuni.reviews.store')); ?>" method="POST" enctype="multipart/form-data" data-ajax="true" data-ajax-action="/api/penghuni/reviews" data-redirect="<?php echo e(route('penghuni.reviews.history')); ?>" data-success-msg="Review berhasil ditambahkan!">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-4 mb-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <?php endif; ?>
                        <div class="flex-1">
                            <h3 class="font-black text-black mb-1"><?php echo e($kos->nama_kos); ?></h3>
                            <div class="flex items-center text-gray-600 text-sm">
                                <i class="fas fa-map-marker-alt mr-2 text-emerald-400"></i>
                                <span class="truncate"><?php echo e($kos->alamat); ?>, <?php echo e($kos->kota); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/penghuni/reviews/create.blade.php ENDPATH**/ ?>
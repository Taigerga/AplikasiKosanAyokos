                ...
                <?php $__empty_1 = true; $__currentLoopData = $kamar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 space-y-3">
                        <div class="flex items-center gap-3">
                            <div class="shrink-0 w-14 h-14 bg-gray-200 border-2 border-black overflow-hidden">
                                <?php if($item->foto_kamar): ?>
                                    <img src="<?php echo e(asset('storage/' . $item->foto_kamar)); ?>" alt="Foto Kamar" class="w-full h-full object-cover">
                                <?php else: ?>
                                    <div class="w-full h-full bg-gray-200 flex items-center justify-center">
                                        <i class="fas fa-bed text-gray-400 text-lg"></i>
                                    </div>
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="text-sm font-black text-black">Kamar <?php echo e($item->nomor_kamar); ?></div>
                                <div class="text-sm text-sky-600 font-black truncate"><?php echo e($item->kos->nama_kos); ?></div>
                                <div class="text-xs text-gray-700">
                                    <i class="fas fa-ruler-combined mr-1"></i><?php echo e($item->luas_kamar ?? 'N/A'); ?> <i class="fas fa-user ml-2 mr-1"></i><?php echo e($item->kapasitas); ?> orang
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="inline-flex items-center px-2 py-1 text-xs font-black bg-gray-200 border-2 border-black text-sky-600">
                                <i class="fas fa-star mr-1 text-xs"></i><?php echo e($item->tipe_kamar); ?>

                            </span>
                            <div class="text-right">
                                <div class="text-sm font-black text-black">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?></div>
                        ...
                        <div class="flex items-center justify-between">
                            <span class="inline-flex items-center px-3 py-1.5 text-xs font-black border-2 border-black
                                ...
                                ($item->status_kamar == 'terisi' ? 'bg-blue-400 text-black' :
                                    'bg-yellow-400 text-black')); ?>">
                                <i class="fas <?php echo e($item->status_kamar == 'tersedia' ? 'fa-door-open' :
                                ($item->status_kamar == 'terisi' ? 'fa-user-check' : 'fa-tools')); ?> mr-1.5 text-xs"></i>
                                <?php echo e(ucfirst($item->status_kamar)); ?>

                            </span>
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('pemilik.kamar.edit', $item->id_kamar)); ?>" class="inline-flex items-center px-3 py-1.5 bg-sky-400 text-black font-black border-2 border-black shadow-[2px_2px_0px_#000] text-xs">

        ...
        if (exportBtn) {
            exportBtn.addEventListener('click', async function () {
                ...
                try {
                    ...
                    const pendapatanPerKosData = <?php echo json_encode($pendapatanPerKosFull, 15, 512) ?>;
                    ...
                    const penghuniPerKosData = <?php echo json_encode($penghuniPerKosFull, 15, 512) ?>;
...
</style><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/pemilik/analisis/pdf-export.blade.php ENDPATH**/ ?>
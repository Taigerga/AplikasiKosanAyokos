                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" 
                                           value="L" id="jenisKelaminL" <?php echo e(old('jenis_kelamin') == 'L' ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" 
                                           value="P" id="jenisKelaminP" <?php echo e(old('jenis_kelamin') == 'P' ? 'checked' : ''); ?>>
                            ...
                            <div class="role-selection">
                                <div class="role-card <?php if(old('role') == 'penghuni'): ?> active <?php endif; ?>" onclick="selectRole('penghuni')">
                                    <input type="radio" name="role" value="penghuni" 
                                           id="rolePenghuni" <?php echo e(old('role') == 'penghuni' ? 'checked' : ''); ?> hidden required>
                                ...
                                <div class="role-card <?php if(old('role') == 'pemilik'): ?> active <?php endif; ?>" onclick="selectRole('pemilik')">
                                    <input type="radio" name="role" value="pemilik" 
                                           id="rolePemilik" <?php echo e(old('role') == 'pemilik' ? 'checked' : ''); ?> hidden required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="p-4 text-center border-top border-dark-border">
                ...
                <a href="<?php echo e(route('login')); ?>" class="fw-semibold text-primary">
                    <i class="fas fa-sign-in-alt me-1"></i>Masuk Sekarang
                </a>
            </div>
            <div class="p-4 text-center pt-0">
                <a href="<?php echo e(route('public.home')); ?>" class="fw-semibold text-secondary">
...
</html><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views/auth/register.blade.php ENDPATH**/ ?>
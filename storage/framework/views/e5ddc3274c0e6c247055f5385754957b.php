...
<div class="p-4 md:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6 hover:shadow-[6px_6px_0px_#000] hover:-translate-y-1 transition-all">
            ...
            <div class="mt-2 space-y-1 text-xs font-bold text-gray-500">
                <div class="flex justify-between"><span>Admin</span><span class="font-black">: <?php echo e($stats['total_admin']); ?></span></div>
                <div class="flex justify-between"><span>Pemilik</span><span class="font-black">: <?php echo e($stats['total_pemilik']); ?></span></div>
                <div class="flex justify-between"><span>Penghuni</span><span class="font-black">: <?php echo e($stats['total_penghuni']); ?></span></div>
            </div>
        </div>
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6 hover:shadow-[6px_6px_0px_#000] hover:-translate-y-1 transition-all">
            ...
            <h3 class="text-3xl font-black text-black mb-1"><?php echo e($stats['total_aduan_open']); ?></h3>
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6 hover:shadow-[6px_6px_0px_#000] hover:-translate-y-1 transition-all">
            ...
            <h3 class="text-3xl font-black text-black mb-1">Rp <?php echo e(number_format($pendapatanBulanIni, 0, ',', '.')); ?></h3>
    ...
    <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a href="<?php echo e(route('admin.aduan.index')); ?>" class="flex flex-col items-center gap-2 p-4 bg-rose-400 hover:bg-rose-500 text-black font-black border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all">
                <i class="fas fa-headset text-2xl"></i>
                <span class="text-sm">Kelola Aduan</span>
            </a>
            <a href="<?php echo e(route('admin.keuangan.index')); ?>" class="flex flex-col items-center gap-2 p-4 bg-orange-400 hover:bg-orange-500 text-black font-black border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[3px_3px_0px_#000] transition-all">

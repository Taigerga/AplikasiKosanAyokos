...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Anda telah menolak pengajuan sewa dari <strong><?php echo e($kontrak->penghuni->nama); ?></strong>.</p>

            <div class="info-box">
                <p><strong>Detail Pengajuan:</strong></p>
                <ul>
                    <li>Nama Calon Penghuni: <?php echo e($kontrak->penghuni->nama); ?></li>
...
</html><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\emails\pemilik\kontrak_ditolak.blade.php ENDPATH**/ ?>
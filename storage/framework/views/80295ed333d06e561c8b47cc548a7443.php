                ...
                <div class="relative">
                    ...
                    <?php else: ?>
                        <div
                            ...
                            <span
                                class="text-4xl md:text-5xl text-green-300 font-bold"><?php echo e(substr($penghuni->nama, 0, 1)); ?></span>
                        </div>
                    <?php endif; ?>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div class="flex-1">
                    <div class="flex items-center space-x-3 mb-2">
                        <h2 class="text-xl md:text-2xl font-bold text-white"><?php echo e($penghuni->nama); ?></h2>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-white"><?php echo e($kontrakAktif); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-white"><?php echo e($totalReview); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-white"><?php echo e($totalPembayaran); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-white capitalize"><?php echo e($penghuni->status_penghuni); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-dark-bg/50 p-5 md:p-6 rounded-xl border border-dark-border">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="font-medium text-white"><?php echo e($user->username); ?></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="font-medium text-white">
                                <?php echo e($penghuni->tanggal_lahir ? \Carbon\Carbon::parse($penghuni->tanggal_lahir)->format('d M Y') : '<span class="text-dark-muted">Belum diisi</span>'); ?>
                ...
                <div class="bg-dark-bg/50 p-5 md:p-6 rounded-xl border border-dark-border">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-white">
                                <?php echo e($penghuni->alamat ?: '<span class="text-dark-muted">Belum diisi</span>'); ?>
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-white">
                                        <span
                                            ...
                                            <?php echo e($penghuni->status_penghuni == 'aktif' ? 'bg-green-900/30 text-green-300' :
           ...
           class="bg-dark-card border border-dark-border rounded-xl p-4 hover:border-green-500/50 transition-all duration-300 group">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-dark-muted"><?php echo e($kontrakAktif ?? 0); ?> kontrak aktif</p>
                </div>
            </div>
        </a>
           ...
           class="bg-dark-card border border-dark-border rounded-xl p-4 hover:border-blue-500/50 transition-all duration-300 group">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-dark-muted"><?php echo e($totalPembayaran ?? 0); ?> pembayaran lunas</p>
                </div>
            </div>
        </a>
           ...
           class="bg-dark-card border border-dark-border rounded-xl p-4 hover:border-yellow-500/50 transition-all duration-300 group">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-dark-muted"><?php echo e($totalReview ?? 0); ?> review ditulis</p>
                </div>
            </div>
        </a>
    </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            document.getElementById('uploadForm').addEventListener('submit', function (e) {
                ...
                fetch('<?php echo e(route("penghuni.profile.upload-photo")); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {

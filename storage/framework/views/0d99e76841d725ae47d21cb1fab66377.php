            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="inline-flex items-center">
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('penghuni.reviews.history')); ?>" class="inline-flex items-center text-sm font-black text-black">
    ...
    <div class="bg-emerald-400 border-2 border-black shadow-[3px_3px_0px_#000] text-black px-4 py-3 flex items-center justify-between" role="alert">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="block text-sm text-black"><?php echo e(session('success')); ?></span>
            </div>
        </div>
    ...
    <div class="bg-red-400 border-2 border-black shadow-[3px_3px_0px_#000] text-black px-4 py-3 flex items-center justify-between" role="alert">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="block text-sm text-black"><?php echo e(session('error')); ?></span>
            </div>
        </div>
        <button type="button" class="text-black hover:text-gray-700" onclick="this.parentElement.style.display='none'">
            <i class="fas fa-times"></i>
    ...
    <div class="bg-yellow-400 border-2 border-black shadow-[3px_3px_0px_#000] text-black px-4 py-3 flex items-center justify-between" role="alert">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="block text-sm text-black"><?php echo e(session('warning')); ?></span>
            </div>
        </div>
        <button type="button" class="text-black hover:text-gray-700" onclick="this.parentElement.style.display='none'">
            <i class="fas fa-times"></i>
...
<?php if(auth()->guard()->check()): ?>
    <?php $penghuniUser = auth()->user(); ?>
                                            <?php if($penghuniUser && $penghuniUser->penghuni && $penghuniUser->penghuni->foto_profil): ?>
                                                ...
                                                <?php else: ?>
                                                    <div class="w-10 h-10 bg-gray-100 border-2 border-black  flex items-center justify-center">
                                                        <span class="text-black font-black text-sm"><?php echo e(strtoupper(substr($penghuniUser->penghuni->nama ?? $penghuniUser->nama, 0, 1))); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <div class="w-10 h-10 bg-gray-100 border-2 border-black  flex items-center justify-center">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <h3 class="text-xl font-black text-black mb-1"><?php echo e($review->kos->nama_kos); ?></h3>
                                            <p class="text-sm text-black font-bold">Review oleh <?php echo e(($penghuniUser->penghuni->nama ?? $penghuniUser->nama) ?? 'User'); ?></p>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-white border-2 border-black shadow-[2px_2px_0px_#000] p-4 mb-4">
                                <div class="flex items-start">
                                    ...
                                    <p class="text-black"><?php echo e($review->komentar); ?></p>
                                </div>
                            </div>
...
<div id="delete-modal" class="fixed inset-0 bg-black/90  z-50 hidden items-center justify-center p-4">
    <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] max-w-md w-full p-6 relative">
        ...
        <form id="delete-form" action="" method="POST" data-ajax="true" data-ajax-method="DELETE" data-success-msg="Review berhasil dihapus" data-redirect="<?php echo e(route('penghuni.reviews.history')); ?>">
            <?php echo csrf_field(); ?>

        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('penghuni.dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-dark-muted hover:text-primary-300">
    ...
    <div class="bg-green-900/30 border border-green-800/50 text-green-300 px-4 py-3 rounded-xl flex items-center justify-between" role="alert">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="block text-sm text-green-300/80"><?php echo e(session('success')); ?></span>
            </div>
        </div>
                        ...
                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center space-x-3 mb-2">
                                        <?php if(auth()->guard('penghuni')->check()): ?>
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-green-400">Review oleh <?php echo e(($penghuniUser->penghuni->nama ?? $penghuniUser->nama) ?? 'User'); ?></p>
                                            </div>
                                    </div>
                            ...
                            <div class="bg-dark-bg/50 border border-dark-border rounded-xl p-4 mb-4">
                                <div class="flex items-start">
                                    ...
                                    <p class="text-dark-text"><?php echo e($review->komentar); ?></p>
                                </div>
                            </div>

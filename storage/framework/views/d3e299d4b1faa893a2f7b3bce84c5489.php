<?php $__env->startSection('title', 'Detail Penghuni - Admin AyoKos'); ?>
...
<div class="p-6">
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
            ...
            <span>></span>
            <a href="<?php echo e(route('admin.data-penghuni.index')); ?>" class="hover:text-black transition">Data Penghuni</a>
            <span>></span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <p class="font-bold text-lg"><?php echo e($penghuni->user->username ?? $penghuni->username ?? '-'); ?></p>
                </div>
                <div>
        ...
        <div class="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <p class="font-bold"><?php echo e($penghuni->user->name ?? $penghuni->name ?? '-'); ?></p>
                </div>
                <div>
                    <p class="text-sm font-black text-gray-500">Email</p>
                    <p class="font-bold"><?php echo e($penghuni->user->email ?? $penghuni->email ?? '-'); ?></p>
                </div>
                <div>
                    <p class="text-sm font-black text-gray-500">No HP</p>
                    <p class="font-bold"><?php echo e($penghuni->no_hp ?? '-'); ?></p>
                </div>
                <div>
                    <p class="text-sm font-black text-gray-500">Jenis Kelamin</p>
                    <p class="font-bold"><?php echo e($penghuni->jenis_kelamin ?? '-'); ?></p>
                </div>
                <div>
                    <p class="text-sm font-black text-gray-500">Tanggal Lahir</p>
                    <p class="font-bold"><?php echo e(isset($penghuni->tanggal_lahir) ? \Carbon\Carbon::parse($penghuni->tanggal_lahir)->format('d M Y') : '-'); ?></p>
                </div>
                <div>
                    <p class="text-sm font-black text-gray-500">Alamat</p>
                    <p class="font-bold"><?php echo e($penghuni->alamat ?? '-'); ?></p>
                </div>
                <div>
        ...
        <div class="lg:col-span-2 bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-6">
            ...
            <form action="<?php echo e(route('admin.data-penghuni.status', $penghuni->id_penghuni)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <select name="status" class="w-full border-2 border-black px-3 py-2 font-bold bg-white focus:outline-none focus:ring-0">
                            <option value="aktif" <?php echo e($penghuni->status == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="nonaktif" <?php echo e($penghuni->status == 'nonaktif' ? 'selected' : ''); ?>>Nonaktif</option>
                            <option value="dibatasi" <?php echo e($penghuni->status == 'dibatasi' ? 'selected' : ''); ?>>Dibatasi</option>
                            <option value="diblokir" <?php echo e($penghuni->status == 'diblokir' ? 'selected' : ''); ?>>Diblokir</option>
                        </select>
                    </div>
                </div>
                <div class="mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AplikasiKosanAyokos\resources\views\admin\data-penghuni\show.blade.php ENDPATH**/ ?>
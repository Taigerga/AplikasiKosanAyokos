                ...
                <div class="profile-menu relative">
                    ...
                    <div
                        ...
                        <div class="px-4 py-3 border-b border-slate-700">
                            <p class="text-sm font-semibold text-white"><?php echo e($user->penghuni->nama ?? $user->nama ?? 'User'); ?></p>
                            <p class="text-xs text-slate-400 truncate"><?php echo e($user->penghuni->email ?? $user->email ?? '-'); ?></p>
                        </div>

            ...
            <div class="flex items-center gap-4">
                ...
                <div class="profile-menu relative">
                    ...
                    <button class="flex items-center gap-2 p-2 rounded-lg hover:bg-slate-100">
                        ...
                        <?php endif; ?>
                        <span
                            class="text-sm font-medium text-slate-800 hidden md:inline"><?php echo e($user->penghuni->nama ?? $user->nama ?? 'User'); ?></span>
...
<div class="flex min-h-[calc(100vh-64px)] relative">
    ...
    <!-- Main Content -->
    <main id="mainContent" class="flex-1 transition-all duration-300 bg-slate-800">
